...
생년월일을 다시 확인해주세요.`);return}y.purpose=e,Pe(y)}catch(G){clearInterval(be),A.classList.add("hidden"),A.innerHTML="",D&&(D.style.display=""),alert(`매칭 오류: ${G.message}`)}finally{k.disabled=!1,k.textContent="인연사찰 찾기"}}})}function rt(e,a){const f=e.eightChar;if(!f)return"";const I=o=>(o==null?void 0:o[0])||"",E=o=>(o==null?void 0:o[1])||"",p=I(f.day),m=I(f.month),$=I(f.year),n=I(f.time),t=E(f.day),z=E(f.month),w=E(f.year),d=E(f.time),B=[d,t,z,w].filter(Boolean),S={甲:{甲:"비견",乙:"겁재",丙:"식신",丁:"상관",戊:"편재",己:"정재",庚:"편관",辛:"정관",壬:"편인",癸:"정인"},乙:{甲:"겁재",乙:"비견",丙:"상관",丁:"식신",戊:"정재",己:"편재",庚:"정관",辛:"편관",壬:"정인",癸:"편인"},丙:{甲:"편인",乙:"정인",丙:"비견",丁:"겁재",戊:"식신",己:"상관",庚:"편재",辛:"정재",壬:"편관",癸:"정관"},丁:{甲:"정인",乙:"편인",丙:"겁재",丁:"비견",戊:"상관",己:"식신",庚:"정재",辛:"편재",壬:"정관",癸:"편관"},戊:{甲:"편관",乙:"정관",丙:"편인",丁:"정인",戊:"비견",己:"겁재",庚:"식신",辛:"상관",壬:"편재",癸:"정재"},己:{甲:"정관",乙:"편관",丙:"정인",丁:"편인",戊:"겁재",己:"비견",庚:"상관",辛:"식신",壬:"정재",癸:"편재"},庚:{甲:"편재",乙:"정재",丙:"편관",丁:"정관",戊:"편인",己:"정인",庚:"비견",辛:"겁재",壬:"식신",癸:"상관"},辛:{甲:"정재",乙:"편재",丙:"정관",丁:"편관",戊:"정인",己:"편인",庚:"겁재",辛:"비견",壬:"상관",癸:"식신"},壬:{甲:"식신",乙:"상관",丙:"편재",丁:"정재",戊:"편관",己:"정관",庚:"편인",辛:"정인",壬:"비견",癸:"겁재"},癸:{甲:"상관",乙:"식신",丙:"정재",丁:"편재",戊:"정관",己:"편관",庚:"정인",辛:"편인",壬:"겁재",癸:"비견"}},Z={비견:"#00D2FF",겁재:"#6B82F9",식신:"#4CAF50",상관:"#81C784",편재:"#FF9800",정재:"#FFB74D",편관:"#F44336",정관:"#EF9A9A",편인:"#CE93D8",정인:"#BA68C8"},ne={비견:"독립심·경쟁심",겁재:"추진력·욕망",식신:"표현력·식복",상관:"재능·자유",편재:"사업·활동성",정재:"안정적 재물",편관:"권력·결단",정관:"명예·원칙",편인:"직관·학문",정인:"학습·보호"},b=o=>p&&S[p]&&S[p][o]||"",k=[{label:"시(時)",gan:n,ji:d,ss:b(n)},{label:"일(日)",gan:p,ji:t,ss:"일원(日元)"},{label:"월(月)",gan:m,ji:z,ss:b(m)},{label:"년(年)",gan:$,ji:w,ss:b($)}],_={};k.forEach(o=>{o.ss&&o.ss!=="일원(日元)"&&(_[o.ss]=(_[o.ss]||0)+1)});const L=`
  ...
  <div class="saju-card" style="margin-bottom:16px;">
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;">
      ${[{label:"시(時)",ji:d},{label:"일(日)",ji:t},{label:"월(月)",ji:z},{label:"년(年)",ji:w}].map(o=>{const ve=y[o.ji]||[];return`<div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:12px;padding:10px 8px;text-align:center;">
          ...
          ${ve.map((ze,Le)=>{const Ae=pe[ze]||"토",Ie=ge[Ae]||"#aaa",Se=b(ze),De=Le===ve.length-1?"정기(正氣)":re[Le]||"";return`<div style="margin-bottom:5px;">
  ...
  </div>`:"",Y=((Ee=e.daYun)==null?void 0:Ee.list)||[],ee=Y.findIndex(U=>U.isCurrent),q=Y[ee],K=ee>=0?Y[ee+1]:null,H=K?K.startAge:null,de=H?H-2:null,P=H?H+2:null,N=new Date().getFullYear(),oe=(a==null?void 0:a.year)||N,ce=N-oe,xe=H!==null&&Math.abs(ce-H)<=3,$e=H?`
  <div class="saju-card" style="${j}">
  ...
  `).join(""),B=a.calendarType==="lunar"?"음력":"양력",S=`${a.hour}시 ${a.minute>0?a.minute+"분":""}`.trim();a.birthLongitude&&`${a.birthLongitude}`;const Z=((D=e.weak)==null?void 0:D.부족오행)??"",ne={목:"#4CAF50",화:"#FF5722",토:"#FF9800",금:"#9E9E9E",수:"#2196F3"},b={목:"木",화:"火",토:"土",금:"金",수:"水"},k=(f==null?void 0:f.results)||[],_=k.length>0?`
    ...
    <div class="saju-card" style="margin-bottom:0;">
      <div class="saju-card-title" style="font-size:13px;">🔮 사주 팔자 (四柱八字) · ${B} ${a.year}년 ${a.month}월 ${a.day}일 · ${S}</div>
      ${z}
...
`+Z)})}),(L=document.getElementById("share-copy-btn"))==null||L.addEventListener("click",function(){var u;var C=document.getElementById("share-copy-btn");(u=navigator.clipboard)==null||u.writeText(S).then(function(){C&&(C.textContent="✅ 복사됨!",setTimeout(function(){C.innerHTML="🔗 링크 복사"},2e3))}).catch(function(){alert("주소: "+S)})})}(),(n=document.getElementById("demo-detail-btn"))==null||n.addEventListener("click",()=>{Ce({score:94,reason:"수(水) 기운이 부족한 사주에 이 사찰의 강한 수 기운이 보완해줍니다.",temple:{name:"통도사",address:"경상남도 양산시 하북면 통도사로 108",lat:35.489166,lng:129.058611,foundedYear:646},detail:{templeOhaeng:"수",bearing:"북",distanceKm:12.3},weather:{condition:"맑음",temp:24}},{purpose:"학업운",distribution:{목:1,화:2,토:2,금:2,수:1},targetOhaeng:"수",purposeGuide:[]},!0)}),a.scrollIntoView({behavior:"smooth"})}function at(e,a){const f={목:"화",화:"토",토:"금",금:"수",수:"목"},I={목:"토",토:"수",수:"화",화:"금",금:"목"},E={목:"木",화:"火",토:"土",금:"金",수:"水"},p={목:"#64DCA0",화:"#FF6B9D",토:"#FB923C",금:"#FFB347",수:"#00D2FF"};let m,$,n,t,z,w;const d=f[e]===a,B=f[a]===e,S=I[e]===a,Z=I[a]===e;return d||B?(m=88,$="상생(相生)",n="천생연분(天生緣分)",t="#00D2FF",z="0,210,255",w="오행이 서로를 생(生)해주는 가장 이상적인 조합입니다. 단, 한쪽이 지나치게 의존하면 소진될 수 있습니다."):e===a?(m=68,$="비화(比和)",n="동질형(同質型)",t="#9FE5C4",z="159,229,196",w="같은 오행으로 서로를 잘 이해하지만, 동일한 약점을 함께 지닙니다. 외부 자극 없이는 정체될 수 있습니다."):S||Z?(m=42,$="상극(相剋)",n="갈등형(葛藤型)",t="#F5A623",z="245,166,35",w="오행이 서로를 극(克)합니다. 긴장과 갈등이 잦을 수 있으며, 의식적인 노력 없이는 관계가 소모적이 될 수 있습니다."):(m=62,$="중화(中和)",n="평범형(平凡型)",t="#FF6B9D",z="255,107,157",w="특별히 맞거나 부딪히는 기운이 없는 평이한 조합입니다. 큰 시너지보다는 무난한 관계가 됩니다."),{score:m,relation:$,grade:n,color:t,rgb:z,comment:w,symA:E[e]||e,symB:E[a]||a,colA:p[e]||"#fff",colB:p[a]||"#fff"}}function lt(e){var U,J,ye,Be,o,ve,ze,Le,Ae,Ie,Se,De;const a=document.getElementById("results");a.classList.remove("hidden");const f=_e(),I=((ye=(J=(U=e.pillarsA)==null?void 0:U[2])==null?void 0:J.wx)==null?void 0:ye[0])||e.targetA,E=((ve=(o=(Be=e.pillarsB)==null?void 0:Be[2])==null?void 0:o.wx)==null?void 0:ve[0])||e.targetB,p=at(I,E),m=(e.hapChung||[]).filter(r=>r.positive).length,$=(e.hapChung||[]).filter(r=>!r.positive).length,n=m*4-$*7,t=Math.max(10,Math.min(99,p.score+n)),z=Math.round(t);window._sajuContext=null,window._gunghamContext={pillarsA:e.pillarsA,pillarsB:e.pillarsB,hapChung:e.hapChung,distributionA:e.distributionA,distributionB:e.distributionB,genderA:e.genderA,genderB:e.genderB,targetA:I,targetB:E,finalScore:t,relation:p.relation,grade:p.grade};const w={목:"#64DCA0",화:"#FF6B9D",토:"#FB923C",금:"#FFB347",수:"#00D2FF"},d={목:"木",화:"火",토:"土",금:"金",수:"水"};function B(r,O,R){return!r||r.length===0?"":`
    <div class="gh-pillar-col">
      ...
      ${R}
    </div>`},se=r=>{var W;const O=[r.a,r.b].sort().join(""),R=ne[O]||ne[[r.b,r.a].join("")]||"";return`<div class="gh-hap-item negative">
      <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
        <span class="gh-hap-type">${r.type}</span>
        <span class="gh-hap-chars">${r.a} ↔ ${r.b}</span>
        ${(W=r.pillars)!=null&&W.length?`<span class="gh-hap-pill">${r.pillars.join(" / ")}</span>`:""}
    ...
    </div>`:"",G=e.distributionA||{},c=e.distributionB||{},h=["목","화","토","금","수"],F={목:"木(목)",화:"火(화)",토:"土(토)",금:"金(금)",수:"水(수)"},j={목:"창의·성장·인자함",화:"열정·표현·감수성",토:"안정·신뢰·중재력",금:"결단·원칙·날카로움",수:"지혜·직관·유연성"},y={};A.forEach(r=>{const O=[r.a,r.b].sort().join("");if((r.type||"").includes("천간합")){const R=S[O]||S[[r.b,r.a].join("")];R!=null&&R.wx&&(y[R.wx]=(y[R.wx]||0)+1)}});const re={목:"창의·성장",화:"정(情)·열정·인연",토:"안정·신뢰",금:"의리·결속",수:"지혜·유연성"},pe=Object.entries(y).sort((r,O)=>O[1]-r[1]),ge=pe.length>0?"✨ 합화오행: "+pe.map(([r,O])=>`<strong style="color:${w[r]||"#fff"}">${F[r]||r}(${re[r]})</strong>${O>1?` ×${O}`:""}`).join(" · ")+" 기운이 두 분 사이에서 생성됩니다.":"",ue=ie?`
    <div class="gh-card">
      <div class="gh-section">
    ...
    </div>`:"",ae={};h.forEach(r=>{ae[r]=(G[r]||0)+(c[r]||0)});const me=[...h].sort((r,O)=>(ae[r]||0)-(ae[O]||0)),s=me[0],l=me[me.length-1],x=h.filter(r=>Math.abs((G[r]||0)-(c[r]||0))>=2);let M="";if(s&&ae[s]<=1&&(M+=`<div class="gh-dist-interp">⚠ 두 분 모두 <strong style="color:${w[s]}">${F[s]}</strong>(${j[s]})이 부족합니다. 이 기운이 약한 영역에서 함께 어려움을 겪을 수 있습니다.</div>`),x.length>0){const r=x[0],O=(G[r]||0)>(c[r]||0);M+=`<div class="gh-dist-interp good">✓ <strong style="color:${w[r]}">${F[r]}</strong>에서 한 분이 강하고 다른 분이 약합니다. ${O?"나":"상대방"}의 ${F[r]} 기운이 ${O?"상대방":"나"}를 채워주는 긍정적인 보완 관계입니다.</div>`}ae[l]>=6&&(M+=`<div class="gh-dist-interp warn">△ 두 분 합산 <strong style="color:${w[l]}">${F[l]}</strong>이 과도합니다. 이 오행의 특성(${j[l]})이 지나치게 강해 균형을 잃을 수 있습니다.</div>`);const v=new Set(["甲","丙","戊","庚","壬"]),g=new Set(["乙","丁","己","辛","癸"]),Y=new Set(["子","寅","辰","午","申","戌"]),ee=new Set(["丑","卯","巳","未","酉","亥"]),q=r=>{let O=0,R=0,W=0,Q=0;return r.forEach(le=>{v.has(le.stem)?O++:g.has(le.stem)&&R++,Y.has(le.branch)?W++:ee.has(le.branch)&&Q++}),{yangStem:O,yinStem:R,yangBranch:W,yinBranch:Q}},K=q(e.pillarsA||[]),H=q(e.pillarsB||[]),de=K.yangStem+K.yangBranch,P=K.yinStem+K.yinBranch,N=H.yangStem+H.yangBranch,oe=H.yinStem+H.yinBranch,ce=(()=>{const r=de>P?"양(陽)형":de<P?"음(陰)형":"균형형",O=N>oe?"양(陽)형":N<oe?"음(陰)형":"균형형",R={"양(陽)형":"활동적이고 외향적입니다. 먼저 나서고 에너지를 발산하는 편입니다.","음(陰)형":"내성적이고 수용적입니다. 관찰하고 흡수하며 내면이 깊습니다.",균형형:"음양이 고르게 분포되어 상황에 따라 유연하게 대처합니다."};let W="";return r!==O?W="서로 다른 음양 기질이 만나 자연스러운 끌림이 생깁니다. 보완 관계가 형성됩니다.":r==="양(陽)형"?W="두 분 모두 적극적이라 활기차지만 주도권 갈등이 생길 수 있습니다.":r==="음(陰)형"?W="두 분 모두 내성적이라 서로를 깊이 이해하지만 먼저 나서는 것을 꺼릴 수 있습니다.":W="두 분 모두 균형 잡힌 기질로 상황 적응력이 좋습니다.",{typeA:r,typeB:O,descA:R[r],descB:R[O],chem:W}})(),xe=`
    <div class="gh-section">
      <div class="gh-section-title">🌊 오행 분포 비교</div>
      <div class="gh-dist-grid">
        ${h.map(r=>{const O=G[r]||0,R=c[r]||0,W=w[r]||"#fff";return`
          <div class="gh-dist-row">
            <span class="gh-dist-name" style="color:${W}">${d[r]||r}(${r})</span>
            <div class="gh-dist-bars">
              <div class="gh-bar-wrap">
                <div class="gh-bar gh-bar-a" style="width:${O/8*100}%;background:${W}"></div>
              </div>
    ...
    <div class="gh-card">
      <div class="gh-section">
        ...
        <div style="display:flex;flex-direction:column;gap:10px;margin-top:8px;">
          ...
          ${W&&Q&&O===R?'<div style="margin-top:4px;padding:8px 12px;background:rgba(255,215,0,0.07);border-radius:8px;font-size:12px;color:rgba(255,215,0,0.8);">✨ 두 분이 같은 일주(同日柱)입니다. 매우 드문 인연으로, 서로를 거울처럼 반추하는 관계입니다.</div>':""}
        </div>
      </div>
    </div>`})():""}
  ...
  `;const ke=document.getElementById("member-code-input"),Ee=document.getElementById("member-code-btn");Ee&&Ee.addEventListener("click",()=>{ke&&ke.value.trim()===Ge?(Re(ke.value.trim()),Pe(e)):alert("코드가 올바르지 않습니다.")}),document.querySelectorAll(".detail-view-btn").forEach(r=>{r.addEventListener("click",()=>{const O=parseInt(r.dataset.templeIndex);Ce(e.results[O],e,f)})}),(Se=document.getElementById("couple-go-home"))==null||Se.addEventListener("click",()=>{var O;a.classList.add("hidden"),a.innerHTML="",window._gunghamContext=null;const r=document.getElementById("match-form");r&&(r.style.display=""),(O=document.getElementById("app"))==null||O.scrollIntoView({behavior:"smooth",block:"start"})}),function(){var He,Te,Ye,Ue;var O=(He=matchData==null?void 0:matchData.results)==null?void 0:He[0],R=((Te=O==null?void 0:O.temple)==null?void 0:Te.name)||"인연사찰",W=(O==null?void 0:O.score)||"",Q=(matchData==null?void 0:matchData.purpose)||"",le="https://jamgong-inyeonsachal.vercel.app",we='🏯 나의 인연사찰은 "'+R+`"!
오행 궁합 `+W+"점 매칭 ("+Q+`)
