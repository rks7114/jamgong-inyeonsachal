(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const z of document.querySelectorAll('link[rel="modulepreload"]'))S(z);new MutationObserver(z=>{for(const p of z)if(p.type==="childList")for(const m of p.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&S(m)}).observe(document,{childList:!0,subtree:!0});function f(z){const p={};return z.integrity&&(p.integrity=z.integrity),z.referrerPolicy&&(p.referrerPolicy=z.referrerPolicy),z.crossOrigin==="use-credentials"?p.credentials="include":z.crossOrigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function S(z){if(z.ep)return;z.ep=!0;const p=f(z);fetch(z.href,p)}})();const Ke=["재물운","건강운","학업운","인연운","가정운","수험합격","취업운","출산기도"],Ze={재물운:"wealth",건강운:"health",학업운:"academic",인연운:"love",가정운:"family",수험합격:"exam",취업운:"career",출산기도:"birth"},Ve={재물운:"geum",건강운:"mok",학업운:"su",인연운:"hwa",가정운:"to",수험합격:"su",취업운:"geum",출산기도:"mok"},Xe={geum:"金",mok:"木",su:"水",hwa:"火",to:"土"},et={재물운:'<circle cx="8" cy="16" r="5"/><circle cx="16" cy="8" r="5"/><path d="M8 16h.01M16 8h.01"/>',건강운:'<path d="M12 3c-3 3-6 6-6 10a6 6 0 0012 0c0-4-3-7-6-10z"/><path d="M12 8v9"/>',학업운:'<path d="M4 19l6-14 2 0 6 14"/><path d="M7 13h10"/><circle cx="18" cy="6" r="2"/>',인연운:'<path d="M8 8a4 4 0 108 0M8 16a4 4 0 108 0M9 9l6 6M15 9l-6 6"/>',가정운:'<path d="M4 11l8-7 8 7"/><path d="M6 10v9h12v-9"/><path d="M10 19v-5h4v5"/>',수험합격:'<path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/>',취업운:'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"/><line x1="12" y1="12" x2="12" y2="12"/>',출산기도:'<path d="M12 2a4 4 0 014 4 4 4 0 01-4 4 4 4 0 01-4-4 4 4 0 014-4z"/><path d="M6 20v-1a6 6 0 0112 0v1"/><path d="M12 14v6"/>'},tt={목:"#3C6E5E",화:"#A23B2E",토:"#B8892B",금:"#8A8F98",수:"#2E4A6B"},it={북:0,동북:45,동:90,동남:135,남:180,남서:225,서:270,북서:315},ot=document.getElementById("app"),Ge="잼공가족2026",Je="jamgong-inyeonsachal-member";function _e(){return localStorage.getItem(Je)==="true"}function Re(e){return e.trim()===Ge?(localStorage.setItem(Je,"true"),!0):!1}const Qe={userLat:37.5665,userLng:126.978,locationLabel:"서울특별시청 (기본값)"};function Ne(){return new Promise(e=>{if(!("geolocation"in navigator)){e(Qe);return}navigator.geolocation.getCurrentPosition(a=>{e({userLat:a.coords.latitude,userLng:a.coords.longitude,locationLabel:"현재 위치 감지됨"})},()=>e(Qe),{timeout:5e3,maximumAge:3e5})})}function nt(){var m,$;ot.innerHTML=`
    ...
    <form class="form-card" id="match-form">
      ...
      <div class="field" id="purpose-field">
        ...
        <div class="purpose-grid" id="purpose-grid">
          ${Ke.map((n,t)=>{const F=Ve[n]||"",w=Xe[F]||"";return`
            <div class="purpose-chip${t===0?" active":""}" data-purpose="${n}" data-ohaeng="${F}">
  ...
  `;let e=Ke[0];document.querySelectorAll(".purpose-chip").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll(".purpose-chip").forEach(t=>t.classList.remove("active")),n.classList.add("active"),e=n.dataset.purpose})});let a="solar";document.querySelectorAll("[data-calendar]").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll("[data-calendar]").forEach(t=>t.classList.remove("active")),n.classList.add("active"),a=n.dataset.calendar,document.getElementById("leap-month-wrap").classList.toggle("hidden",a!=="lunar")})}),(m=document.getElementById("birth-hour"))==null||m.addEventListener("change",n=>{const t=document.getElementById("birth-minute");t&&(t.disabled=n.target.value==="")}),($=document.getElementById("birth-city"))==null||$.addEventListener("change",n=>{const t=document.getElementById("birth-lng-display");t&&(t.textContent=n.target.value?"경도 "+n.target.value+"°":"")});let f="male";document.querySelectorAll(".gender-btn").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll(".gender-btn").forEach(t=>t.classList.remove("active")),n.classList.add("active"),f=n.dataset.gender})});let S="solar";document.querySelectorAll("[data-calendar-b]").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll("[data-calendar-b]").forEach(t=>t.classList.remove("active")),n.classList.add("active"),S=n.dataset.calendarB})});let z="female";document.querySelectorAll(".gender-btn-b").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll(".gender-btn-b").forEach(t=>t.classList.remove("active")),n.classList.add("active"),z=n.dataset.genderB})});let p="solo";document.querySelectorAll(".mode-toggle-btn").forEach(n=>{n.addEventListener("click",()=>{document.querySelectorAll(".mode-toggle-btn").forEach(M=>M.classList.remove("active")),n.classList.add("active"),p=n.dataset.mode;const t=document.getElementById("birth-b-field"),F=document.getElementById("birth-label-a"),w=document.getElementById("submit-btn"),d=document.getElementById("purpose-field"),j=document.getElementById("location-field");if(p==="couple")t.classList.remove("hidden"),t.style.display="flex",F.innerHTML='<span class="label-badge-a">나</span> 생년월일시',w.textContent="함께 인연사찰 찾기",d&&(d.style.display=""),j&&(j.style.display="");else if(p==="saju"){t.classList.add("hidden"),t.style.display="none",F.innerHTML='생년월일시 <span class="help-tip" tabindex="0">?<span class="help-tip-bubble">사주 팔자 계산의 기준이 되는 정보입니다.</span></span>',w.textContent="🔮 사주 팔자 확인",d&&(d.style.display="none"),j&&(j.style.display="none"),document.getElementById("match-form").style.display="",document.getElementById("temple-search-wrap").style.display="";const M=document.getElementById("dream-page");M&&(M.style.display="none")}else if(p==="dream"){document.getElementById("match-form").style.display="none",document.getElementById("temple-search-wrap").style.display="none";let M=document.getElementById("dream-page");M||(dt(),M=document.getElementById("dream-page")),M&&(M.style.display="")}else{t.classList.add("hidden"),t.style.display="none",F.innerHTML='생년월일시 <span class="help-tip" tabindex="0">?<span class="help-tip-bubble">사주 오행 계산의 기준이 되는 정보입니다. 시간을 모르셔도 괜찮습니다 — "시간 모름"을 선택하시면 정오 기준으로 계산됩니다.</span></span>',w.textContent="인연사찰 찾기",d&&(d.style.display=""),j&&(j.style.display=""),document.getElementById("match-form").style.display="",document.getElementById("temple-search-wrap").style.display="";const M=document.getElementById("dream-page");M&&(M.style.display="none")}})}),document.getElementById("match-form").addEventListener("submit",async n=>{var N,k,C,u,V,T,ie,Z;n.preventDefault();const t=document.getElementById("birth-year").value,F=document.getElementById("birth-month").value,w=document.getElementById("birth-day").value,d=document.getElementById("birth-hour").value,j=parseInt((N=document.getElementById("birth-minute"))==null?void 0:N.value)||0,M=Math.min(59,Math.max(0,j)),W=((k=document.getElementById("birth-city"))==null?void 0:k.value)||"",ne=((C=document.getElementById("is-leap-month"))==null?void 0:C.checked)||!1;if(!t||!F||!w){alert("생년월일(연도·월·일)을 모두 선택해주세요.");return}const b={calendarType:a,year:parseInt(t),month:parseInt(F),day:parseInt(w),hour:d!==""?parseInt(d):12,minute:M,isLeapMonth:ne,birthLongitude:W!==""?parseFloat(W):null,gender:f};if(p==="couple"){const D=document.getElementById("birth-year-b").value,A=document.getElementById("birth-month-b").value,i=document.getElementById("birth-day-b").value;if(!D||!A||!i){alert("상대방 생년월일(연도·월·일)을 모두 선택해주세요.");return}}if(p==="saju"){const D=document.getElementById("submit-btn");D.disabled=!0;const A=document.getElementById("match-form");A&&(A.style.display="none");const i=document.getElementById("results");i.classList.remove("hidden");const te=[{icon:"🔍",text:"위치 감지 중..."},{icon:"🌀",text:"사주 오행 분석 중..."},{icon:"✨",text:"AI 풀이 생성 중..."},{icon:"🏯",text:"인연사찰 탐색 중..."},{icon:"🔮",text:"팔자 기운 살피는 중..."}];let se=0;(()=>{const c=te[se%te.length];i.innerHTML=`
          <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:320px;gap:28px;padding:40px 20px;">
            ...
            <div style="display:flex;gap:6px;">
              ${te.map((h,L)=>`<div class="saju-dot" style="width:6px;height:6px;border-radius:50%;background:${L===se%te.length?"rgba(0,210,255,0.9)":"rgba(255,255,255,0.15)"};transition:background .3s;"></div>`).join("")}
            </div>
          </div>`})();const _=setInterval(()=>{se++;const c=te[se%te.length],h=document.getElementById("saju-loading-text");h&&(h.textContent=c.text),document.querySelectorAll(".saju-dot").forEach((E,y)=>{E.style.background=y===se%te.length?"rgba(0,210,255,0.9)":"rgba(255,255,255,0.15)"});const L=i.querySelector("[style*='font-size:28px']");L&&(L.textContent=c.icon)},2200);try{const[c,h]=await Promise.all([fetch("/api/saju",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({birthInput:b})}),Ne()]),L=await c.json();if(L.error){clearInterval(_),i.classList.add("hidden"),A&&(A.style.display=""),alert(L.error);return}let E=null,y=null;const re=h.userLat??37.5665,pe=h.userLng??126.978,ge=ue=>new Promise((ae,me)=>setTimeout(()=>me(new Error("timeout")),ue));try{const[ue,ae]=await Promise.all([fetch("/api/match",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({birthInput:b,userLat:re,userLng:pe,purpose:"인연운"})}),Promise.race([fetch("/api/saju-explain",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({eightChar:L.eightChar,distribution:L.distribution,weak:L.weak,daYun:L.daYun?{...L.daYun,list:(u=L.daYun.list)==null?void 0:u.filter(me=>me.isCurrent||me.startAge>=30)}:null,samjae:L.samjae,birthInput:b})}),ge(38e3)]).catch(()=>null)]);ue!=null&&ue.ok&&(E=await ue.json()),ae!=null&&ae.ok&&(y=await ae.json())}catch(ue){console.warn("병렬 오류:",ue)}clearInterval(_),We(L,b,E,(y==null?void 0:y.explanation)||null)}catch{clearInterval(_),i.classList.add("hidden"),i.innerHTML="",A&&(A.style.display=""),alert("사주 계산 중 오류가 발생했습니다.")}finally{D.disabled=!1,D.textContent="🔮 사주 팔자 확인"}return}const B=document.getElementById("submit-btn");if(B.disabled=!0,p==="couple"){const D=document.getElementById("match-form"),A=document.getElementById("results");D&&(D.style.display="none"),A.classList.remove("hidden");const i=[{icon:"💑",text:"두 분의 기운을 살피는 중..."},{icon:"🔮",text:"팔자 여덟 글자 분석 중..."},{icon:"⚡",text:"합충(合沖) 관계 탐색 중..."},{icon:"🌊",text:"오행 시너지 계산 중..."},{icon:"🏯",text:"두 분의 인연 기운 정리 중..."},{icon:"✨",text:"궁합 결과 생성 완료 중..."}];let te=0;(()=>{const _=i[te%i.length];A.innerHTML=`
          ...
          </div>`})();const ve=setInterval(()=>{te++;const _=i[te%i.length],c=document.getElementById("couple-loading-text");c&&(c.textContent=_.text);const h=A.querySelector("[style*='font-size:30px']");h&&(h.textContent=_.icon),A.querySelectorAll(".couple-dot").forEach((L,E)=>{L.style.background=E===te%i.length?"rgba(245,100,200,0.9)":"rgba(255,255,255,0.15)"})},5e3);try{const _=document.getElementById("birth-year-b").value,c=document.getElementById("birth-month-b").value,h=document.getElementById("birth-day-b").value,L=document.getElementById("birth-hour-b").value,E={calendarType:S,year:parseInt(_),month:parseInt(c),day:parseInt(h),hour:L!==""?parseInt(L):12,minute:0,isLeapMonth:!1,gender:z},y=await Ne().catch(()=>({})),re=y.userLat??37.5665,pe=y.userLng??126.978,ge=new Promise(me=>setTimeout(me,5e3)),[ue]=await Promise.all([fetch("/api/match-couple",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({birthInputA:b,birthInputB:E,purpose:e,userLat:re,userLng:pe,memberUnlocked:_e(),region:((V=document.getElementById("region-select"))==null?void 0:V.value)||"",maxDistanceKm:parseInt((T=document.getElementById("distance-select"))==null?void 0:T.value)||null})}),ge]),ae=await ue.json();if(clearInterval(ve),ae.error){A.classList.add("hidden"),A.innerHTML="",D&&(D.style.display=""),alert(`오류: ${ae.error}
생년월일을 다시 확인해주세요.`);return}ae.purpose=e,lt(ae)}catch{clearInterval(ve),A.classList.add("hidden"),A.innerHTML="",D&&(D.style.display=""),alert("궁합 분석 중 오류가 발생했습니다. 잠시 후 다시 시도해 주세요.")}finally{B.disabled=!1,B.textContent="💑 궁합"}return}{const D=document.getElementById("match-form"),A=document.getElementById("results");D&&(D.style.display="none"),A.classList.remove("hidden");const i=[{icon:"🔍",text:"위치 감지 중..."},{icon:"🌀",text:"오행 기운 분석 중..."},{icon:"🏯",text:"인연사찰 탐색 중..."},{icon:"✨",text:"나의 인연을 살피는 중..."},{icon:"🔮",text:"사주 기운 정렬 중..."},{icon:"🌸",text:"결과 생성 완료 중..."}];let te=0;(()=>{const _=i[te%i.length];A.innerHTML=`
          <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:340px;gap:24px;padding:40px 20px;">
            <div style="position:relative;width:88px;height:88px;">
              <svg viewBox="0 0 88 88" style="width:88px;height:88px;animation:spin 2s linear infinite;">
          ...
          </div>`})();const ve=setInterval(()=>{te++;const _=i[te%i.length],c=document.getElementById("solo-loading-text");c&&(c.textContent=_.text);const h=A.querySelector("[style*='font-size:30px']");h&&(h.textContent=_.icon),A.querySelectorAll(".solo-dot").forEach((L,E)=>{L.style.background=E===te%i.length?"rgba(0,210,255,0.9)":"rgba(255,255,255,0.15)"})},5e3);try{const _=new Promise(re=>setTimeout(re,5e3)),c=await Ne().catch(()=>({})),h=c.userLat??37.5665,L=c.userLng??126.978,[E]=await Promise.all([fetch("/api/match",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({birthInput:b,purpose:e,userLat:h,userLng:L,memberUnlocked:_e(),region:((ie=document.getElementById("region-select"))==null?void 0:ie.value)||"",maxDistanceKm:parseInt((Z=document.getElementById("distance-select"))==null?void 0:Z.value)||null})}),_]);if(!E.ok){const re=await E.text().catch(()=>"");throw new Error(`HTTP ${E.status}: ${re.slice(0,300)}`)}const y=await E.json();if(clearInterval(ve),y.error){A.classList.add("hidden"),A.innerHTML="",D&&(D.style.display=""),alert(`오류: ${y.error}
생년월일을 다시 확인해주세요.`);return}y.purpose=e,Pe(y)}catch(_){clearInterval(ve),A.classList.add("hidden"),A.innerHTML="",D&&(D.style.display=""),alert(`매칭 오류: ${_.message}`)}finally{B.disabled=!1,B.textContent="인연사찰 찾기"}}})}function rt(e,a){const f=e.eightChar;if(!f)return"";const S=o=>(o==null?void 0:o[0])||"",z=o=>(o==null?void 0:o[1])||"",p=S(f.day),m=S(f.month),$=S(f.year),n=S(f.time),t=z(f.day),F=z(f.month),w=z(f.year),d=z(f.time),j=[d,t,F,w].filter(Boolean),M={甲:{甲:"비견",乙:"겁재",丙:"식신",丁:"상관",戊:"편재",己:"정재",庚:"편관",辛:"정관",壬:"편인",癸:"정인"},乙:{甲:"겁재",乙:"비견",丙:"상관",丁:"식신",戊:"정재",己:"편재",庚:"정관",辛:"편관",壬:"정인",癸:"편인"},丙:{甲:"편인",乙:"정인",丙:"비견",丁:"겁재",戊:"식신",己:"상관",庚:"편재",辛:"정재",壬:"편관",癸:"정관"},丁:{甲:"정인",乙:"편인",丙:"겁재",丁:"비견",戊:"상관",己:"식신",庚:"정재",辛:"편재",壬:"정관",癸:"편관"},戊:{甲:"편관",乙:"정관",丙:"편인",丁:"정인",戊:"비견",己:"겁재",庚:"식신",辛:"상관",壬:"편재",癸:"정재"},己:{甲:"정관",乙:"편관",丙:"정인",丁:"편인",戊:"겁재",己:"비견",庚:"상관",辛:"식신",壬:"정재",癸:"편재"},庚:{甲:"편재",乙:"정재",丙:"편관",丁:"정관",戊:"편인",己:"정인",庚:"비견",辛:"겁재",壬:"식신",癸:"상관"},辛:{甲:"정재",乙:"편재",丙:"정관",丁:"편관",戊:"정인",己:"편인",庚:"겁재",辛:"비견",壬:"상관",癸:"식신"},壬:{甲:"식신",乙:"상관",丙:"편재",丁:"정재",戊:"편관",己:"정관",庚:"편인",辛:"정인",壬:"비견",癸:"겁재"},癸:{甲:"상관",乙:"식신",丙:"정재",丁:"편재",戊:"정관",己:"편관",庚:"정인",辛:"편인",壬:"겁재",癸:"비견"}},W={비견:"#00D2FF",겁재:"#6B82F9",식신:"#4CAF50",상관:"#81C784",편재:"#FF9800",정재:"#FFB74D",편관:"#F44336",정관:"#EF9A9A",편인:"#CE93D8",정인:"#BA68C8"},ne={비견:"독립심·경쟁심",겁재:"추진력·욕망",식신:"표현력·식복",상관:"재능·자유",편재:"사업·활동성",정재:"안정적 재물",편관:"권력·결단",정관:"명예·원칙",편인:"직관·학문",정인:"학습·보호"},b=o=>p&&M[p]&&M[p][o]||"",B=[{label:"시(時)",gan:n,ji:d,ss:b(n)},{label:"일(日)",gan:p,ji:t,ss:"일원(日元)"},{label:"월(月)",gan:m,ji:F,ss:b(m)},{label:"년(年)",gan:$,ji:w,ss:b($)}],N={};B.forEach(o=>{o.ss&&o.ss!=="일원(日元)"&&(N[o.ss]=(N[o.ss]||0)+1)});const k=`
  <div class="saju-card" style="margin-bottom:16px;">
    ...
    <div style="overflow-x:auto;">
      <table style="width:100%;border-collapse:collapse;text-align:center;">
        <tr>${B.map(o=>`<th style="padding:8px 4px;color:rgba(255,255,255,0.4);font-size:11px;font-weight:500;border-bottom:1px solid rgba(255,255,255,0.08);">${o.label}</th>`).join("")}</tr>
        <tr>${B.map(o=>`<td style="padding:10px 4px;font-size:13px;font-weight:800;color:${o.ss==="일원(日元)"?"rgba(255,255,255,0.25)":W[o.ss]||"#fff"};">${o.ss}</td>`).join("")}</tr>
        <tr>${B.map(o=>`<td style="padding:4px;font-size:10px;color:rgba(255,255,255,0.35);line-height:1.4;">${o.ss==="일원(日元)"?"나 자신":ne[o.ss]||""}</td>`).join("")}</tr>
      </table>
    </div>
    <div style="margin-top:12px;display:flex;flex-wrap:wrap;gap:6px;">
      ${Object.entries(N).sort((o,ee)=>ee[1]-o[1]).map(([o,ee])=>`<span style="background:rgba(255,255,255,0.05);border:1px solid ${W[o]||"#888"}44;border-radius:20px;padding:4px 11px;font-size:12px;"><span style="color:${W[o]||"#fff"};font-weight:700;">${o}</span><span style="color:rgba(255,255,255,0.35);"> ×${ee}</span></span>`).join("")}
    </div>
  </div>`,C={申:"A",子:"A",辰:"A",寅:"B",午:"B",戌:"B",亥:"C",卯:"C",未:"C",巳:"D",酉:"D",丑:"D"},u=C[w]||C[t],V={A:"酉",B:"卯",C:"子",D:"午"},T={A:"寅",B:"申",C:"巳",D:"亥"},ie={A:"辰",B:"戌",C:"未",D:"丑"},Z={甲:["丑","未"],戊:["丑","未"],庚:["丑","未"],乙:["子","申"],己:["子","申"],丙:["亥","酉"],丁:["亥","酉"],壬:["卯","巳"],癸:["卯","巳"],辛:["午","寅"]},D={甲:"卯",丙:"午",戊:"午",庚:"酉",壬:"子",乙:"辰",丁:"未",己:"未",辛:"戌",癸:"丑"},A=[j.includes(V[u])&&{name:"도화살(桃花殺)",icon:"🌸",color:"#FF6B9D",desc:"매력·인기운이 강합니다. 이성 관계와 예술·연예 분야에 유리합니다."},j.includes(T[u])&&{name:"역마살(驛馬殺)",icon:"🐴",color:"#FF9800",desc:"활동성이 강하고 변화가 많습니다. 해외·출장·이사 등 이동수가 있습니다."},(Z[p]||[]).some(o=>j.includes(o))&&{name:"천을귀인(天乙貴人)",icon:"⭐",color:"#FFD700",desc:"귀인의 도움을 받는 길성입니다. 위기 때 구원자가 나타납니다."},j.includes(D[p])&&{name:"양인살(羊刃殺)",icon:"⚔️",color:"#F44336",desc:"강한 승부욕·의지력. 칼날 같은 기운으로 신중함이 필요합니다."},j.includes(ie[u])&&{name:"화개살(華蓋殺)",icon:"🔮",color:"#9C27B0",desc:"예술·종교·철학적 소질이 있습니다. 고독하지만 깊은 내면을 가집니다."}].filter(Boolean),i=A.some(o=>o.name.includes("역마살")),te=A.some(o=>o.name.includes("천을귀인")),se=i&&te?`<div style="margin-top:14px;background:linear-gradient(135deg,rgba(255,215,0,0.08),rgba(255,152,0,0.05));border:1px solid rgba(255,215,0,0.25);border-radius:12px;padding:14px;">
  ...
  <div class="saju-card" style="margin-bottom:16px;">
    ...
    ${se}
  </div>`,_="丙",c="午",h=b(_),L={甲:"병(丙)화가 목(木)일간을 생(生)하여 활동 에너지가 높아집니다. 새로운 도전에 유리한 해입니다.",乙:"병(丙)화가 목(木)일간을 생(生)하여 표현력과 창의성이 빛납니다.",丙:"비견(比肩) 해 — 경쟁이 강해지고 독립심이 높아집니다. 자기 주도적 행동이 중요합니다.",丁:"겁재(劫財) 해 — 의지력이 강해지나 주변과 마찰이 생길 수 있습니다.",戊:"편인(偏印) 해 — 학문·직관이 발달하고 새로운 기술 습득에 유리합니다.",己:"정인(正印) 해 — 학습운이 좋고 윗사람의 도움을 받을 수 있는 해입니다.",庚:"편관(偏官) 해 — 긴장감과 도전이 많지만 승진·도약의 기회가 옵니다.",辛:"정관(正官) 해 — 명예로운 기회와 안정된 직업운을 기대할 수 있습니다.",壬:"편재(偏財) 해 — 활동적인 재물운, 사업 확장과 투자 기회가 생깁니다.",癸:"정재(正財) 해 — 안정적인 수입과 실속 있는 재물운의 해입니다."},E=`
  <div class="saju-card" style="margin-bottom:16px;">
    ...
    <div style="display:flex;gap:10px;align-items:stretch;margin-bottom:14px;">
      ...
      <div style="flex:1;background:rgba(255,100,0,0.05);border:1px solid rgba(255,100,0,0.15);border-radius:12px;padding:12px;">
        ...
        <div style="font-size:16px;font-weight:800;color:${W[h]||"#fff"};">${h||"—"}</div>
      </div>
    </div>
    <div style="font-size:13px;color:rgba(255,255,255,0.75);line-height:1.9;padding:12px;background:rgba(255,100,0,0.05);border-radius:10px;border:1px solid rgba(255,100,0,0.12);">
      ${L[p]||"2026년 병오(丙午)년 화(火) 기운이 사주에 영향을 줍니다."}
    </div>
  ...
  <div class="saju-card" style="margin-bottom:16px;">
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;">
      ${[{label:"시(時)",ji:d},{label:"일(日)",ji:t},{label:"월(月)",ji:F},{label:"년(年)",ji:w}].map(o=>{const ee=y[o.ji]||[];return`<div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:12px;padding:10px 8px;text-align:center;">
          <div style="font-size:12px;color:rgba(255,255,255,0.65);margin-bottom:6px;">${o.label} · ${o.ji||"?"}</div>
          ${ee.map((fe,je)=>{const Ae=pe[fe]||"토",Se=ge[Ae]||"#aaa",Ce=b(fe),Me=je===ee.length-1?"정기(正氣)":re[je]||"";return`<div style="margin-bottom:5px;">
              <span style="font-size:15px;font-weight:800;color:${Se};">${fe}</span>
              <span style="font-size:11px;color:rgba(255,255,255,0.6);display:block;line-height:1.3;">${Me}</span>
              ${Ce?`<span style="font-size:9px;color:${W[Ce]||"#aaa"};font-weight:600;">${Ce}</span>`:""}
            </div>`}).join("")}
          ${ee.length===0?'<div style="color:rgba(255,255,255,0.45);font-size:11px;">—</div>':""}
        </div>`}).join("")}
    </div>
    <div style="margin-top:10px;font-size:12px;color:rgba(255,255,255,0.55);">💡 정기(正氣)가 가장 강한 핵심 에너지, 여기는 전 계절의 잔여 기운입니다.</div>
  </div>`,me=["甲","乙","丙","丁","戊","己","庚","辛","壬","癸"],s=["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"],l=[["戌","亥"],["申","酉"],["午","未"],["辰","巳"],["寅","卯"],["子","丑"]],x={子:"자",丑:"축",寅:"인",卯:"묘",辰:"진",巳:"사",午:"오",未:"미",申:"신",酉:"유",戌:"술",亥:"해"},O=me.indexOf(p),v=s.indexOf(t);let g=O;for(;g%12!==v&&g<60;)g+=10;const Y=Math.floor(g/10),X=l[Y]||[],U=[d,t,F,w].filter(Boolean),K=X.filter(o=>U.includes(o)),H={戌:"술(戌) 공망 — 토(土)·믿음·종교·부동산 영역에서 허무함을 느낄 수 있습니다.",亥:"해(亥) 공망 — 수(水)·지혜·철학·여행 분야에서 노력 대비 결실이 약할 수 있습니다.",申:"신(申) 공망 — 금(金)·재물·법·조직 영역에서 공허함이 생깁니다.",酉:"유(酉) 공망 — 금(金)·명예·이성 인연·결실 분야가 채워지지 않는 느낌이 있습니다.",午:"오(午) 공망 — 화(火)·명성·열정·중년의 성취가 기대보다 약할 수 있습니다.",未:"미(未) 공망 — 토(土)·가정·전통·안정감에서 결핍을 느낍니다.",辰:"진(辰) 공망 — 토(土)·사업·현실 기반·실속이 흔들릴 수 있습니다.",巳:"사(巳) 공망 — 화(火)·계획·지식·전문성 영역에서 허탕을 치기 쉽습니다.",寅:"인(寅) 공망 — 목(木)·시작·도전·형제 인연이 공허합니다.",卯:"묘(卯) 공망 — 목(木)·창의력·학문·이성 인연이 약해집니다.",子:"자(子) 공망 — 수(水)·지혜·부하·자녀 인연에서 결핍이 생깁니다.",丑:"축(丑) 공망 — 토(土)·재고·비밀·말년 안정이 불안할 수 있습니다."},le=`
  <div class="saju-card" style="margin-bottom:16px;">
    ...
    <div style="display:flex;gap:10px;align-items:center;margin-bottom:12px;flex-wrap:wrap;">
      ...
      <div style="flex:1;min-width:120px;">
        ${K.length>0?`<div style="font-size:12px;font-weight:700;color:#FF8A80;margin-bottom:4px;">⚠️ 원국에 공망 해당 글자 있음</div>
             <div style="font-size:11px;color:rgba(255,255,255,0.55);">${K.map(o=>x[o]).join("·")} 자리가 구멍납니다. 이 영역에서 노력해도 공허함이 생기는 원인입니다.</div>`:`<div>
  ...
  </div>`,P=[n,p,m,$].filter(Boolean),G=[d,t,F,w].filter(Boolean),de=[{a:"甲",b:"己",result:"土합",desc:"갑기합(甲己合) — 리더십(木)과 포용력(土)이 결합, 안정적 추진력을 발휘합니다. 공직·기업 경영에 이상적입니다."},{a:"乙",b:"庚",result:"金합",desc:"을경합(乙庚合) — 유연함(木)과 단호함(金)이 결합, 협상력과 결단력을 동시에 갖춥니다."},{a:"丙",b:"辛",result:"水합",desc:"병신합(丙辛合) — 열정(火)과 예리함(金)이 수(水)로 변환, 전략적 분석력과 깊은 통찰이 생깁니다."},{a:"丁",b:"壬",result:"木합",desc:"정임합(丁壬合) — 감수성(火)과 지혜(水)가 목(木)으로 변환, 창의적 영감과 인문학적 재능이 발달합니다."},{a:"戊",b:"癸",result:"火합",desc:"무계합(戊癸合) — 현실감(土)과 직관(水)이 화(火)로 변환, 열정적 행동력과 카리스마가 형성됩니다."}].filter(o=>P.includes(o.a)&&P.includes(o.b)),we=[{group:["申","子","辰"],result:"水局",desc:"수(水) 기운이 강하게 형성"},{group:["巳","酉","丑"],result:"金局",desc:"금(金) 기운이 강하게 형성"},{group:["寅","午","戌"],result:"火局",desc:"화(火) 기운이 강하게 형성"},{group:["亥","卯","未"],result:"木局",desc:"목(木) 기운이 강하게 형성"}].map(o=>({cnt:o.group.filter(fe=>G.includes(fe)).length,...o})).filter(o=>o.cnt>=2),$e=[{a:"子",b:"丑",result:"土합",desc:"자축합(子丑合) — 수(水)와 토(土)가 결합해 단단한 땅을 형성합니다. 신용·자산 기반이 흔들림 없이 지켜지는 강한 결속력입니다."},{a:"寅",b:"亥",result:"木합",desc:"인해합(寅亥合) — 목(木) 기운이 강화됩니다. 시작과 성장의 에너지가 서로를 북돋아 새로운 도전에 유리합니다."},{a:"卯",b:"戌",result:"火합",desc:"묘술합(卯戌合) — 화(火) 기운으로 변합니다. 따뜻한 정(情)과 열정이 관계를 불태우지만, 집착이 될 수 있어 균형이 필요합니다."},{a:"辰",b:"酉",result:"金합",desc:"진유합(辰酉合) — 금(金) 기운이 강해집니다. 현실적 판단력과 재물 결실이 단단하게 쌓이는 실속형 결합입니다."},{a:"巳",b:"申",result:"水합",desc:"사신합(巳申合) — 수(水) 기운으로 변합니다. 지혜·전략·소통이 강화되나, 화(火)와 금(金)의 긴장이 내재합니다."},{a:"午",b:"未",result:"土합",desc:"오미합(午未合) — 토(土) 기운이 두터워집니다. 중심을 잡아주는 안정 에너지로, 중년 이후 자산 축적에 유리합니다."}].filter(o=>G.includes(o.a)&&G.includes(o.b)),Be=[{a:"子",b:"午",desc:"子午충 — 수화(水火) 충돌, 변동·이동수 강함"},{a:"丑",b:"未",desc:"丑未충 — 토토(土土) 충돌, 직장·부동산 변동"},{a:"寅",b:"申",desc:"寅申충 — 목금(木金) 충돌, 충동적 행동 주의"},{a:"卯",b:"酉",desc:"卯酉충 — 목금(木金) 충돌, 이성 관계·인간관계 마찰"},{a:"辰",b:"戌",desc:"辰戌충 — 토토(土土) 충돌, 기반·환경의 급변"},{a:"巳",b:"亥",desc:"巳亥충 — 화수(火水) 충돌, 사업·건강의 기복"}].filter(o=>G.includes(o.a)&&G.includes(o.b)),ke=`
  <div class="saju-card" style="margin-bottom:16px;">
    ...
    <div style="margin-bottom:12px;">
      ...
      ${de.map(o=>`<div style="background:rgba(0,210,255,0.05);border:1px solid rgba(0,210,255,0.15);border-radius:10px;padding:12px;margin-bottom:6px;">
    ...
    <div style="margin-bottom:12px;">
      ...
      ${we.map(o=>`<div style="background:rgba(76,175,80,0.05);border:1px solid rgba(76,175,80,0.18);border-radius:10px;padding:10px 12px;margin-bottom:6px;font-size:12px;color:rgba(255,255,255,0.75);">
        <span style="font-size:13px;font-weight:800;color:#AED581;margin-right:8px;">${o.group.filter(ee=>G.includes(ee)).join("·")} ${o.cnt===2?"반삼합":"삼합"}</span>${o.desc} <span style="color:rgba(255,255,255,0.4);">(→ ${o.result})</span>
    ...
    <div style="margin-bottom:12px;">
      ...
      ${$e.map(o=>`<div style="background:rgba(156,39,176,0.05);border:1px solid rgba(156,39,176,0.18);border-radius:10px;padding:12px;margin-bottom:6px;">
    ...
    <div>
      ...
      ${Be.map(o=>`<div style="background:rgba(244,67,54,0.05);border:1px solid rgba(244,67,54,0.18);border-radius:10px;padding:10px 12px;margin-bottom:6px;font-size:12px;color:rgba(255,255,255,0.75);">
        <span style="font-size:14px;font-weight:800;color:#EF9A9A;margin-right:8px;">${o.a}↔${o.b}</span>${o.desc}
      </div>`).join("")}
    </div>`:""}

    ${de.length===0&&we.length===0&&$e.length===0&&Be.length===0?'<div style="font-size:12px;color:rgba(255,255,255,0.35);padding:8px 0;">원국 내 주요 합·충이 없습니다 — 대운·세운에서 형성될 때 주목하세요.</div>':""}
    <div style="margin-top:10px;font-size:12px;color:rgba(255,255,255,0.55);">💡 2026 丙午년: 午를 포함한 寅午戌 화국(火局) 가능성 체크</div>
  </div>`,ze=[{a:"子",b:"未",desc:"자(子)–미(未) 원진 — 서로 미워하고 불편한 관계"},{a:"丑",b:"午",desc:"축(丑)–오(午) 원진 — 의리 있지만 갈등 반복"},{a:"寅",b:"酉",desc:"인(寅)–유(酉) 원진 — 시작은 좋지만 결국 어긋남"},{a:"卯",b:"申",desc:"묘(卯)–신(申) 원진 — 예민함과 강함의 충돌"},{a:"辰",b:"亥",desc:"진(辰)–해(亥) 원진 — 마음은 맞지만 행동이 어긋남"},{a:"巳",b:"戌",desc:"사(巳)–술(戌) 원진 — 가까울수록 상처받기 쉬움"}],q=[{a:"子",b:"酉",desc:"자–유 귀문 — 강한 집착·예민한 감수성"},{a:"丑",b:"午",desc:"축–오 귀문 — 감정 기복·강박적 성향"},{a:"寅",b:"亥",desc:"인–해 귀문 — 신비로운 직관, 과몰입 주의"},{a:"卯",b:"申",desc:"묘–신 귀문 — 예민함·과한 상상력"},{a:"辰",b:"巳",desc:"진–사 귀문 — 의심·불안감"},{a:"未",b:"戌",desc:"미–술 귀문 — 우울·집착 경향"}],be=ze.filter(o=>G.includes(o.a)&&G.includes(o.b)),Ee=q.filter(o=>G.includes(o.a)&&G.includes(o.b)),Le=`
  <div class="saju-card" style="margin-bottom:16px;">
    ...
    <div style="margin-bottom:12px;">
      ...
      ${be.map(o=>`<div style="background:rgba(244,67,54,0.05);border:1px solid rgba(244,67,54,0.2);border-radius:10px;padding:12px;margin-bottom:6px;">
    ...
    <div>
      ...
      ${Ee.map(o=>`<div style="background:rgba(156,39,176,0.05);border:1px solid rgba(156,39,176,0.2);border-radius:10px;padding:12px;margin-bottom:6px;">
  ...
  <div class="saju-card" style="${E}">
    ...
    <div style="display:flex;gap:12px;align-items:flex-start;">
      ...
      <div style="flex:1;">
        ${d.map((q,be)=>`<div style="display:flex;gap:8px;align-items:flex-start;${be<d.length-1?"margin-bottom:10px":""}"><span style="color:#00d2ff;font-size:13px;flex-shrink:0;margin-top:2px;">${["①","②","③"][be]||"✦"}</span><span style="font-size:13px;color:rgba(255,255,255,0.82);line-height:1.75;">${q}</span></div>`).join("")}
      </div>
    </div>
  </div>`,ge=`
  <div class="saju-card" style="${E}">
    ...
    <div style="margin-bottom:12px;">${ne.jobs.map(q=>re(q,"rgba(76,175,80,0.1)","rgba(76,175,80,0.3)","#81C784")).join("")}</div>
  ...
  <div class="saju-card" style="${E}">
    ...
    <div style="background:rgba(255,152,0,0.08);border:1px solid rgba(255,152,0,0.25);border-radius:12px;padding:14px;margin-bottom:10px;">
      <div style="font-size:16px;font-weight:800;color:#FFB74D;margin-bottom:8px;">${k}</div>
  ...
  <div class="saju-card" style="${E}">
    ${y("❤️","연애·결혼운")}
    <div style="font-size:15px;font-weight:800;color:#EF9A9A;margin-bottom:10px;">${Z}</div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
      ...
      <div style="background:rgba(255,152,0,0.06);border:1px solid rgba(255,152,0,0.18);border-radius:12px;padding:12px;">
        ...
        <div style="font-size:12px;color:rgba(255,255,255,0.7);line-height:1.7;">${A}</div>
      </div>
    </div>
  </div>`,me=`
  <div class="saju-card" style="${E}">
  ...
  <div class="saju-card" style="${E}">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
      <div style="background:rgba(0,200,100,0.05);border:1px solid rgba(0,200,100,0.2);border-radius:12px;padding:14px;">
        ...
        ${L.do_.map(q=>`<div style="display:flex;gap:6px;align-items:flex-start;margin-bottom:8px;"><span style="color:#69F0AE;flex-shrink:0;font-size:11px;margin-top:2px;">▸</span><span style="font-size:12px;color:rgba(255,255,255,0.78);line-height:1.65;">${q}</span></div>`).join("")}
      </div>
    ...
    <div style="display:flex;flex-direction:column;gap:10px;">
      <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:14px;">
        ...
        <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:6px;">
          ${v.colors.map(q=>`<span style="background:rgba(255,213,79,0.1);border:1px solid rgba(255,213,79,0.3);border-radius:20px;padding:4px 12px;font-size:12px;color:#FFD54F;font-weight:600;">${q}</span>`).join("")}
        </div>
  ...
  </div>`:"",Y=((ze=e.daYun)==null?void 0:ze.list)||[],X=Y.findIndex(q=>q.isCurrent),U=Y[X],K=X>=0?Y[X+1]:null,H=K?K.startAge:null,le=H?H-2:null,P=H?H+2:null,G=new Date().getFullYear(),oe=(a==null?void 0:a.year)||G,de=G-oe,xe=H!==null&&Math.abs(de-H)<=3,we=H?`
  <div class="saju-card" style="${E}">
    ...
    <div style="background:rgba(255,193,7,0.07);border:1px solid rgba(255,193,7,0.22);border-radius:12px;padding:14px;margin-bottom:12px;">
      <div style="font-size:12px;font-weight:700;color:#FFD54F;margin-bottom:5px;">
        ${xe?"⚡ 현재 교운기 진행 중":"📅 다음 교운기 예정"}
      </div>
      <div style="font-size:13px;color:rgba(255,255,255,0.85);line-height:1.7;">
        <strong style="color:#FFD54F;">만 ${le}세~${P}세</strong> 구간이 교운기(대운 환절기)입니다.
        ${U?`현재 <strong style="color:#00D2FF;">${U.ganZhi}</strong> 대운에서 `:""}
        ${K?`<strong style="color:#69F0AE;">${K.ganZhi}</strong> 대운으로 기운이 전환됩니다.`:""}
      </div>
    </div>
  ...
  <div class="saju-card" style="${E}">
    ...
    <div style="display:flex;flex-direction:column;gap:10px;">
      <div style="background:linear-gradient(135deg,rgba(0,210,255,0.06),rgba(107,130,249,0.04));border:1px solid rgba(0,210,255,0.2);border-radius:12px;padding:14px;">
        ...
        <div style="font-size:18px;font-weight:900;color:#00D2FF;margin-bottom:6px;letter-spacing:1px;">${$e.guiIn.jilju}</div>
        <div style="font-size:12px;color:rgba(255,255,255,0.72);line-height:1.8;">${$e.guiIn.reason}</div>
      </div>
      <div style="background:linear-gradient(135deg,rgba(105,240,174,0.06),rgba(0,200,83,0.04));border:1px solid rgba(105,240,174,0.2);border-radius:12px;padding:14px;">
        ...
        <div style="font-size:12px;color:rgba(255,255,255,0.72);line-height:1.8;">${$e.energy.desc}</div>
  ...
  </div>`:"";return pe+ge+ue+ae+me+s+l+g+we+De}function We(e,a,f,S){var Z,D,A,i,te,se,ve,_;window._gunghamContext=null,window._sajuContext={eightChar:e.eightChar,distribution:e.distribution,weak:e.weak,daYun:e.daYun,samjae:e.samjae,birthInput:a,temples:((Z=f==null?void 0:f.results)==null?void 0:Z.slice(0,3).map(c=>{var h,L;return{name:(h=c.temple)==null?void 0:h.name,address:(L=c.temple)==null?void 0:L.address}}))||[]};const z=document.getElementById("results");z.classList.remove("hidden");const p=document.getElementById("match-form");p&&(p.style.display="none");const m={木:"목",火:"화",土:"토",金:"금",水:"수"},$={목:"#4CAF50",화:"#FF5722",토:"#FF9800",금:"#9E9E9E",수:"#2196F3"},n={목:"木 목",화:"火 화",토:"土 토",금:"金 금",수:"水 수"},t=e.eightChar,F=t?(()=>{const c=[{label:"시(時)",char:t.time,wx:t.timeWx},{label:"일(日)",char:t.day,wx:t.dayWx},{label:"월(月)",char:t.month,wx:t.monthWx},{label:"년(年)",char:t.year,wx:t.yearWx}],h=y=>y?y[0]:"",L=y=>y?y[1]:"",E=c.map(y=>{const re=[...y.wx||""].map(ge=>m[ge]).filter(Boolean),pe=$[re[0]]||"#00d2ff";return{chars:re,col:pe}});return`
    <table class="saju-table">
      ...
      <tbody>
        <tr class="saju-table-gan">
          ${c.map((y,re)=>`<td style="color:${E[re].col}">${h(y.char)}</td>`).join("")}
        </tr>
        <tr class="saju-table-ji">
          ${c.map((y,re)=>`<td style="color:${E[re].col}">${L(y.char)}</td>`).join("")}
        </tr>
        <tr class="saju-table-wx">
          ${E.map(y=>`<td style="color:${y.col};font-size:11px;">${y.chars.join("·")}</td>`).join("")}
        </tr>
      </tbody>
    </table>`})():'<p style="color:rgba(255,255,255,0.5);text-align:center;">사주 계산 결과를 불러올 수 없습니다.</p>',w=e.distribution||{},d=Object.entries(w).map(([c,h])=>`
  ...
  `).join(""),j=a.calendarType==="lunar"?"음력":"양력",M=`${a.hour}시 ${a.minute>0?a.minute+"분":""}`.trim();a.birthLongitude&&`${a.birthLongitude}`;const W=((D=e.weak)==null?void 0:D.부족오행)??"",ne={목:"#4CAF50",화:"#FF5722",토:"#FF9800",금:"#9E9E9E",수:"#2196F3"},b={목:"木",화:"火",토:"土",금:"金",수:"水"},B=(f==null?void 0:f.results)||[],N=B.length>0?`
    <div class="saju-dist-section" style="border-color:rgba(0,210,255,0.3);">
      <div class="saju-dist-title">🏯 나의 인연사찰 추천
        ${W?`<span style="font-size:12px;font-weight:400;color:${ne[W]||"#00d2ff"};margin-left:8px;">· ${W}(${b[W]||""}) 기운 보완</span>`:""}
      </div>
      ${B.slice(0,5).map((c,h)=>{var y;const L=c.temple||{},E=(y=c.detail)==null?void 0:y.distanceKm;return`
        <div style="display:flex;align-items:center;gap:12px;padding:14px 12px;margin-top:8px;background:rgba(0,210,255,0.04);border:1px solid rgba(0,210,255,0.12);border-radius:12px;">
          ...
          <div style="flex:1;min-width:0;">
            <div style="font-size:16px;font-weight:800;color:#fff;">${L.name||""}</div>
            <div style="font-size:12px;color:rgba(255,255,255,0.45);margin-top:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">${L.address||""}</div>
            ${E!=null?`<div style="font-size:12px;color:var(--cyan);margin-top:3px;">📍 ${E<1?(E*1e3).toFixed(0)+"m":E.toFixed(1)+"km"}</div>`:""}
    ...
    </div>`:'<div class="saju-notice-banner" style="text-align:center;">📍 위치를 확인하는 중이었거나 사찰 데이터를 불러오지 못했습니다.<br><button class="submit-btn" style="margin-top:12px;padding:10px 24px;" id="retry-match-btn">🔄 인연사찰 다시 찾기</button></div>',k=`
    <div class="saju-card" style="margin-bottom:0;">
      <div class="saju-card-title" style="font-size:13px;">🔮 사주 팔자 (四柱八字) · ${j} ${a.year}년 ${a.month}월 ${a.day}일 · ${M}</div>
      ${F}
      <div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:12px;justify-content:center;">
        ${d?`<details style="width:100%;"><summary style="cursor:pointer;font-size:12px;color:rgba(255,255,255,0.4);list-style:none;">▼ 오행 분포 보기</summary><div style="margin-top:8px;">${d}</div></details>`:""}
      </div>
            ...
            <div class="dayun-block ${c.isCurrent?"dayun-current":""}">
              ...
              <div class="liunian-grid" style="display:${c.isCurrent?"grid":"none"}">
                ${c.liuNian.map(L=>`
                  <div class="liunian-item ${L.isCurrent?"liunian-current":""}">
                    <span class="liunian-year">${L.year}</span>
                    <span class="liunian-gz">${L.ganZhi}</span>
                    <span class="liunian-age">${L.age}세</span>
                  </div>`).join("")}
              </div>`:""}
            </div>`}).join("")}`,e.samjae&&`${((A=e.samjae)==null?void 0:A.animalsKo)||""}${e.samjae.samjaeTarget}${e.samjae.groups.map(c=>{const h=new Date().getFullYear(),L=c.some(E=>E.year===h||E.year===h-1||E.year===h+1);return`<div class="samjae-group ${L?"samjae-active":""}">
            ${L?'<span class="samjae-now-badge">현재 삼재</span>':""}
            ${c.map((E,y)=>`<span class="samjae-year-item">${E.year}년(${E.zhiKo}·${y===0?"들삼재":y===1?"눌삼재":"날삼재"})</span>`).join(" → ")}
          </div>`}).join("")}`;const C=S?S.replace(/^#{1,3}\s+(.+)$/gm,'<h3 class="saju-explain-h3">$1</h3>').replace(/^---+$/gm,'<hr style="border:none;border-top:1px solid rgba(0,210,255,0.15);margin:12px 0;">').replace(/\*\*(.+?)\*\*/g,'<strong class="saju-explain-heading">$1</strong>').replace(/\n\n/g,"</p><p>").replace(/\n/g,"<br>").replace(/^/,"<p>").replace(/$/,"</p>").replace(/<p>\s*(<h3|<hr)/g,"$1").replace(/(<\/h3>|<hr[^>]*>)\s*<\/p>/g,"$1"):"",u=`
    <div class="saju-explain-card">
      <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px;">
        <div class="saju-card-title" style="margin-bottom:0;">📖 나의 사주 풀이</div>
        ${S?'<button id="saju-download-btn" style="background:linear-gradient(135deg,#00d2ff,#7b5ea7);border:none;border-radius:10px;padding:9px 18px;color:#fff;font-weight:700;font-size:13px;cursor:pointer;white-space:nowrap;">📥 결과 다운받기</button>':""}
      </div>
      <div class="saju-explain-body" id="saju-ai-explanation">${S?C:`
    ...
    </div>`,V=new Date().getFullYear(),ie=((te=(i=e.samjae)==null?void 0:i.groups)==null?void 0:te.some(c=>c.some(h=>Math.abs(h.year-V)<=1)))?(()=>{const c=e.samjae.groups.find(E=>E.some(y=>Math.abs(y.year-V)<=1))||[],h=c.find(E=>Math.abs(E.year-V)<=1),L=(h==null?void 0:h.year)<V?"들삼재 마무리 단계":(h==null?void 0:h.year)===V?"눌삼재(삼재 중반)":"날삼재(삼재 마무리)";return`<div style="background:rgba(220,50,50,0.1);border:1.5px solid rgba(220,80,80,0.4);border-radius:14px;padding:16px 18px;display:flex;gap:12px;align-items:flex-start;">
      ...
      <div>
        ...
        <div style="font-size:13px;color:rgba(255,255,255,0.75);line-height:1.6;">
          ${c.map((E,y)=>`<span>${E.year}년(${["들삼재","눌삼재","날삼재"][y]})</span>`).join(" → ")}<br>
          현재: <strong style="color:#ff8080;">${L}</strong> — 사주 풀이 하단의 삼재 주의사항을 확인하세요.
        </div>
      </div>
    </div>`})():"";z.innerHTML=`
    ...
    <div class="saju-page-wrap">
      <div id="saju-noprint-top">${ie}</div>
      ${u}
      ${rt(e)}
      ${st(e,a)}
      <div id="saju-noprint-bottom">${N}${k}</div>
    </div>`,z.scrollIntoView({behavior:"smooth",block:"start"}),(se=document.getElementById("saju-go-home"))==null||se.addEventListener("click",()=>{var h;z.classList.add("hidden"),z.innerHTML="";const c=document.getElementById("match-form");c&&(c.style.display=""),(h=document.getElementById("app"))==null||h.scrollIntoView({behavior:"smooth",block:"start"})}),(ve=document.getElementById("saju-download-btn"))==null||ve.addEventListener("click",()=>{var me,s;const c=a.calendarType==="lunar"?"음력":"양력",h=`${a.hour}시${a.minute>0?" "+a.minute+"분":""}`,L=`사주 풀이 — ${c} ${a.year}년 ${a.month}월 ${a.day}일 ${h}`,E=(f==null?void 0:f.results)||[],y=E.slice(0,5).map((l,x)=>{var g;const O=l.temple||{},v=(g=l.detail)==null?void 0:g.distanceKm;return`<div class="p-temple"><span class="p-rank">${x+1}위</span> <strong>${O.name||""}</strong><br>
       <span class="p-addr">${O.address||""}</span>${v!=null?" · "+(v<1?(v*1e3).toFixed(0)+"m":v.toFixed(1)+"km"):""}
       &nbsp;${l.score||""}점</div>`}).join(""),re=e.eightChar?[{l:"시(時)",c:e.eightChar.time,w:e.eightChar.timeWx},{l:"일(日)",c:e.eightChar.day,w:e.eightChar.dayWx},{l:"월(月)",c:e.eightChar.month,w:e.eightChar.monthWx},{l:"년(年)",c:e.eightChar.year,w:e.eightChar.yearWx}]:[],pe={목:"#2e7d32",화:"#c62828",토:"#e65100",금:"#455a64",수:"#1565c0"},ge={木:"목",火:"화",土:"토",金:"금",水:"수"},ue=re.length?`
      <table class="p-table">
        <tr><th>구분</th>${re.map(l=>`<th>${l.l}</th>`).join("")}</tr>
        <tr><td>천간</td>${re.map(l=>{var v;const x=[...l.w].map(g=>ge[g]).filter(Boolean);return`<td style="color:${pe[x[0]]||"#333"};font-size:26px;font-weight:900;">${((v=l.c)==null?void 0:v[0])||""}</td>`}).join("")}</tr>
        <tr><td>지지</td>${re.map(l=>{var v;const x=[...l.w].map(g=>ge[g]).filter(Boolean);return`<td style="color:${pe[x[0]]||"#333"};font-size:26px;font-weight:900;">${((v=l.c)==null?void 0:v[1])||""}</td>`}).join("")}</tr>
        <tr><td>오행</td>${re.map(l=>`<td style="font-size:12px;">${[...l.w].map(O=>ge[O]).filter(Boolean).join("·")}</td>`).join("")}</tr>
      </table>`:"",ae=(s=(me=e.daYun)==null?void 0:me.list)==null?void 0:s.find(l=>l.isCurrent);`${L}${L}${new Date().toLocaleDateString("ko-KR")}${ue}`,E.length&&`${y}`,`${C.replace(/class="saju-explain-heading"/g,'class="explain-heading"')}`,ae&&`${e.daYun.direction}${e.daYun.startAge}${e.daYun.list.map(l=>`
          <div class="dayun-chip ${l.isCurrent?"current":""}">
            ${l.isCurrent?"▶ ":""}${l.startAge}세 ${l.ganZhi}
          </div>`).join("")}`,window.print()}),(_=document.getElementById("retry-match-btn"))==null||_.addEventListener("click",async()=>{const c=document.getElementById("retry-match-btn");c.textContent="탐색 중...",c.disabled=!0;try{const{userLat:h,userLng:L}=await Ne(),y=await(await fetch("/api/match",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({birthInput:a,userLat:h,userLng:L,purpose:"healing"})})).json();y.error||We(e,a,y,S)}catch{c.textContent="🔄 다시 찾기",c.disabled=!1}})}function Ie(e,a,f,S){var me;const z=document.getElementById("results");z.classList.remove("hidden");const p=document.getElementById("match-form");p&&(p.style.display="none");const m=e.temple||{},$=e.detail||{},n=e.score||0,t={목:{c:"#4ADE80",r:"74,222,128"},화:{c:"#FB923C",r:"251,146,60"},토:{c:"#FACC15",r:"250,204,21"},금:{c:"#F0C060",r:"240,192,96"},수:{c:"#38BDF8",r:"56,189,248"}},F=t[$.templeOhaeng]||t.금,w=F.c,d=F.r,j={info:{c:"#60A5FA",r:"96,165,250"},loc:{c:"#F87171",r:"248,113,113"},ohaeng:{c:w,r:d},reason:{c:"#C084FC",r:"192,132,252"},purpose:{c:w,r:d},guide:{c:"#34D399",r:"52,211,153"},gido:{c:"#FCD34D",r:"252,211,77"},date:{c:"#818CF8",r:"129,140,248"},dist:{c:w,r:d}};function M(s,l,x){return'<div class="ds-card" style="background:rgba('+s.r+",0.06);border:1px solid rgba("+s.r+",0.22);border-left:4px solid "+s.c+';border-radius:16px;padding:20px 20px 20px 22px;margin-bottom:12px;"><div style="font-size:14px;font-weight:800;color:'+s.c+";margin-bottom:12px;padding-bottom:10px;border-bottom:1px solid rgba("+s.r+',0.2);letter-spacing:.05em;">'+l+'</div><div style="font-size:14px;color:#E2E8F0;line-height:1.9;">'+x+"</div></div>"}const W={목:"🌿",화:"🔥",토:"🌍",금:"✨",수:"💧"},ne={목:"성장·창의·도전",화:"열정·명예·활력",토:"안정·신뢰·중심",금:"결실·의지·재물",수:"지혜·학업·직관"},b={목:"새로운 일을 시작하거나 창의적인 활동에 힘을 불어넣어 줍니다.",화:"이름을 알리고 사람들 사이에서 빛나게 해주는 기운입니다.",토:"흔들리는 마음을 안정시키고 근본을 다지게 해줍니다.",금:"결실을 맺고 재물과 의지력을 강화시켜 줍니다.",수:"지혜와 직관을 높여주고 학업·시험에 도움이 됩니다."},B=W[$.templeOhaeng]||"✦",N=a?a.distribution||{}:{},k=a&&a.purpose||"",C=a?a.purposeGuide||[]:[],u=a?a.recommendedDates||[]:[],V=f?u.length:Math.min(3,u.length),T=m.history||"",ie=f?T:T.length>120?T.slice(0,120)+'… <span style="color:rgba(255,255,255,0.35);font-size:12px;">🔒 전체보기는 멤버 전용</span>':T||"정보 없음",Z="https://map.naver.com/v5/search/"+encodeURIComponent((m.name||"")+" "+(m.address||"")),D=$.distanceKm!=null?$.distanceKm<1?Math.round($.distanceKm*1e3)+"m":$.distanceKm.toFixed(1)+"km":"정보 없음",A=e.weather?'<div style="display:inline-flex;align-items:center;gap:7px;background:rgba(56,189,248,0.15);border:1px solid rgba(56,189,248,0.4);border-radius:20px;padding:5px 14px;font-size:13px;color:#7DD3FA;margin-top:10px;">🌤 <b>'+e.weather.condition+"</b>&nbsp;"+e.weather.temp+"°C</div>":"";let i='<div class="temple-detail-page">';i+="<style>.ds-card{transition:transform .18s ease,box-shadow .18s ease,border-color .18s ease;cursor:default;}.ds-card:hover{transform:translateY(-3px);box-shadow:0 8px 32px rgba(0,0,0,.35);border-color:rgba(255,255,255,0.28) !important;}.ds-card:hover .ds-title{letter-spacing:.07em;}#detail-back-btn:hover{background:rgba(255,255,255,0.16);}.detail-date-card{transition:transform .15s,box-shadow .15s;}.detail-date-card:hover{transform:translateY(-4px) scale(1.06);box-shadow:0 8px 24px rgba(0,0,0,.4);}</style>",i+='<button id="detail-back-btn" style="display:inline-flex;align-items:center;gap:6px;background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.2);color:rgba(255,255,255,0.8);border-radius:20px;padding:8px 18px;font-size:13px;font-weight:600;cursor:pointer;margin-bottom:18px;transition:background .15s;">← 목록으로</button>',i+='<div id="detail-hero" style="position:relative;overflow:hidden;background:linear-gradient(160deg,rgba('+d+",0.18) 0%,rgba(0,0,0,0) 70%);border:1px solid rgba("+d+",0.35);border-top:3px solid "+w+';border-radius:22px;padding:28px 22px 22px;margin-bottom:16px;text-align:center;">',i+='<div id="detail-hero-img" style="position:absolute;inset:0;background-size:cover;background-position:center top;border-radius:22px;opacity:0;transition:opacity .6s ease;"></div>',i+='<div id="detail-hero-overlay" style="position:absolute;inset:0;background:linear-gradient(180deg,rgba(5,10,25,0.55) 0%,rgba(5,10,25,0.82) 100%);border-radius:22px;opacity:0;transition:opacity .6s ease;"></div>',i+='<div style="position:relative;z-index:1;">',i+='<div style="font-size:11px;letter-spacing:.2em;color:'+w+';text-transform:uppercase;margin-bottom:8px;font-weight:700;opacity:.9;">'+B+"  "+($.templeOhaeng||"")+"(오행) · "+(ne[$.templeOhaeng]||"")+"</div>",i+='<div style="font-size:clamp(28px,5vw,40px);font-weight:900;color:#fff;margin-bottom:6px;letter-spacing:-.5px;text-shadow:0 0 30px rgba('+d+',.4);">'+(m.name||"사찰")+"</div>",m.foundedYear&&(i+='<div style="font-size:12px;color:rgba(255,255,255,0.35);margin-bottom:4px;">창건 '+m.foundedYear+"년</div>"),i+=A,i+='<div style="margin-top:18px;">',i+='<div style="display:flex;justify-content:space-between;font-size:12px;margin-bottom:6px;"><span style="color:rgba(255,255,255,0.45);">인연 매칭 점수</span><span style="color:'+w+';font-weight:800;font-size:15px;">'+n+"점</span></div>",i+='<div style="height:10px;background:rgba(0,0,0,0.4);border-radius:5px;overflow:hidden;">',i+='<div style="height:100%;width:'+Math.min(n,100)+"%;background:linear-gradient(90deg,"+w+" 0%,#fff 120%);border-radius:5px;box-shadow:0 0 12px rgba("+d+',.7);"></div>',i+="</div></div></div></div>",i+='<div id="temple-gallery" style="display:none;margin-bottom:14px;"><div style="font-size:13px;font-weight:800;color:rgba(255,255,255,0.5);margin-bottom:8px;letter-spacing:.08em;">📷 사찰 사진</div><div id="gallery-scroll" style="display:flex;gap:10px;overflow-x:auto;padding-bottom:8px;scrollbar-width:thin;scrollbar-color:rgba(255,255,255,0.15) transparent;"></div></div>';const te=j.info;i+='<div class="ds-card" style="background:rgba('+te.r+",0.06);border:1px solid rgba("+te.r+",0.22);border-left:4px solid "+te.c+';border-radius:16px;padding:20px 20px 20px 22px;margin-bottom:12px;">',i+='<div style="font-size:14px;font-weight:800;color:'+te.c+";margin-bottom:14px;padding-bottom:10px;border-bottom:1px solid rgba("+te.r+',0.2);letter-spacing:.05em;">🏯 사찰 기본 정보</div>',i+='<div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">',i+='<div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:14px;">',i+='<div style="font-size:11px;color:rgba(255,255,255,0.4);margin-bottom:6px;letter-spacing:.1em;">🧭 방위</div>',i+='<div style="font-size:16px;font-weight:800;color:#E2E8F0;">'+($.bearing||"—")+"</div></div>",i+='<div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:14px;">',i+='<div style="font-size:11px;color:rgba(255,255,255,0.4);margin-bottom:6px;letter-spacing:.1em;">📏 거리</div>',i+='<div style="font-size:16px;font-weight:800;color:#E2E8F0;">'+D+"</div></div>",i+='<div style="background:rgba('+d+",0.1);border:1px solid rgba("+d+',0.35);border-radius:12px;padding:14px;">',i+='<div style="font-size:11px;color:rgba('+d+',.6);margin-bottom:6px;letter-spacing:.1em;">'+B+" 오행 기운</div>",i+='<div style="font-size:15px;font-weight:800;color:'+w+';">'+($.templeOhaeng||"—")+" · "+(ne[$.templeOhaeng]||"—")+"</div></div>",i+='<div style="background:rgba('+d+",0.1);border:1px solid rgba("+d+',0.35);border-radius:12px;padding:14px;">',i+='<div style="font-size:11px;color:rgba('+d+',.6);margin-bottom:6px;letter-spacing:.1em;">⭐ 매칭 점수</div>',i+='<div style="font-size:16px;font-weight:800;color:'+w+';">'+n+"점</div></div>",i+="</div></div>",function(){var s=(m.history||"")+" "+(m.name||""),l=[];/조계종/.test(s)?l.push({icon:"⛩️",label:"대한불교 조계종",color:"#34D399",r:"52,211,153"}):/태고종/.test(s)?l.push({icon:"⛩️",label:"한국불교 태고종",color:"#818CF8",r:"129,140,248"}):/천태종/.test(s)?l.push({icon:"⛩️",label:"천태종",color:"#38BDF8",r:"56,189,248"}):/진각종/.test(s)&&l.push({icon:"⛩️",label:"진각종",color:"#FB923C",r:"251,146,60"});var x=null;if(m.foundedYear){var O=parseInt(m.foundedYear);O<668?x={icon:"🏺",label:"삼국시대 고찰",color:"#F472B6",r:"244,114,182"}:O<935?x={icon:"🏛️",label:"통일신라 고찰",color:"#FBBF24",r:"251,191,36"}:O<1392?x={icon:"🏯",label:"고려시대 고찰",color:"#FBBF24",r:"251,191,36"}:O<1897?x={icon:"🏯",label:"조선시대 사찰",color:"#94A3B8",r:"148,163,184"}:x={icon:"🕌",label:"근현대 사찰",color:"#94A3B8",r:"148,163,184"}}else/신라 (문무왕|진흥왕|경덕왕|흥덕왕|선덕왕|태종무열)/.test(s)?x={icon:"🏛️",label:"통일신라 고찰",color:"#FBBF24",r:"251,191,36"}:/고려/.test(s)&&!/조선/.test(s)?x={icon:"🏯",label:"고려시대 고찰",color:"#FBBF24",r:"251,191,36"}:/신라/.test(s)&&!/고려|조선/.test(s)?x={icon:"🏛️",label:"신라 고찰",color:"#FBBF24",r:"251,191,36"}:/조선/.test(s)&&(x={icon:"🏯",label:"조선시대 사찰",color:"#94A3B8",r:"148,163,184"});if(x&&l.push(x),/국보 제?\d+호|국보[가-힣 ]*제?\d+/.test(s)?l.push({icon:"🏆",label:"국보 보유",color:"#FBBF24",r:"251,191,36"}):/보물 제?\d+호|보물[가-힣 ]*제?\d+/.test(s)&&l.push({icon:"💎",label:"보물 보유",color:"#D4AF37",r:"212,175,55"}),/사적 제?\d+호|사적지/.test(s)&&l.push({icon:"📜",label:"사적지",color:"#94A3B8",r:"148,163,184"}),/원효대사|원효/.test(s)?l.push({icon:"🧘",label:"원효대사 창건",color:"#818CF8",r:"129,140,248"}):/의상대사|의상/.test(s)&&l.push({icon:"🧘",label:"의상대사 창건",color:"#818CF8",r:"129,140,248"}),/임진왜란|병자호란|의병/.test(s)&&l.push({icon:"🛡️",label:"호국불교",color:"#FB923C",r:"251,146,60"}),/본사/.test(s)&&l.push({icon:"🏯",label:"교구 본사",color:"#F472B6",r:"244,114,182"}),/템플스테이/.test(s)&&l.push({icon:"🌙",label:"템플스테이",color:"#38BDF8",r:"56,189,248"}),!!l.length){var v='<div style="display:flex;flex-wrap:wrap;gap:8px;">'+l.map(function(g){return'<span style="display:inline-flex;align-items:center;gap:5px;background:rgba('+g.r+",0.12);border:1px solid rgba("+g.r+",0.35);color:"+g.color+';border-radius:20px;padding:6px 14px;font-size:12px;font-weight:700;">'+g.icon+" "+g.label+"</span>"}).join("")+"</div>";i+=M({r:"148,163,184",c:"#94A3B8"},"🏷️ 사찰 특징",v)}}();const se=j.loc;if(i+='<div class="ds-card" style="background:rgba('+se.r+",0.06);border:1px solid rgba("+se.r+",0.22);border-left:4px solid "+se.c+';border-radius:16px;padding:20px 20px 20px 22px;margin-bottom:12px;">',i+='<div style="font-size:14px;font-weight:800;color:'+se.c+";margin-bottom:12px;padding-bottom:10px;border-bottom:1px solid rgba("+se.r+',0.2);">📍 위치 &amp; 방문 안내</div>',m.address&&(i+='<div style="font-size:14px;color:#CBD5E1;margin-bottom:14px;line-height:1.7;">'+m.address+"</div>"),i+='<a href="'+Z+'" target="_blank" rel="noopener" style="display:block;text-align:center;background:rgba('+se.r+",0.12);border:1px solid rgba("+se.r+",0.35);color:"+se.c+';border-radius:12px;padding:12px;font-weight:700;font-size:14px;text-decoration:none;">🗺️ 네이버 지도에서 길찾기</a>',i+="</div>",$.templeOhaeng&&b[$.templeOhaeng]){var ve={목:{env:"🌿 동쪽 · 숲·계곡",season:"봄(3~5월) 방문 최적",color:"#4ADE80",r:"74,222,128",detail:"생명력과 성장의 기운이 충만한 도량입니다. 울창한 수목과 맑은 물소리가 어우러져 마음을 새롭게 열어주며, 새로운 시작·가정화목·창의적 도전에 특히 좋습니다."},화:{env:"☀️ 남쪽 · 양지·온기",season:"여름(6~8월) 방문 최적",color:"#F97316",r:"249,115,22",detail:"밝고 따뜻한 불꽃 기운이 살아 숨쉬는 도량입니다. 햇살이 가득한 남향 터에 자리잡아 좋은 인연·명예·활력을 끌어당기는 강한 화(火) 에너지가 흐릅니다."},토:{env:"🏔️ 중앙 · 산중·평지",season:"환절기(3·9월) 방문 최적",color:"#FACC15",r:"250,204,21",detail:"대지의 안정된 기운이 깊게 뿌리내린 도량입니다. 든든하고 포근한 토(土) 에너지가 흔들리는 심신을 안정시키고, 건강·치유·신뢰 회복에 알맞습니다."},금:{env:"🍂 서쪽 · 산자락·바위",season:"가을(9~11월) 방문 최적",color:"#D4AF37",r:"212,175,55",detail:"결실과 의지의 금(金) 기운이 가득한 도량입니다. 가을 수확처럼 노력에 합당한 결실을 맺게 해주며, 재물운·결단력·성취를 기원하기에 최적의 터입니다."},수:{env:"💧 북쪽 · 계곡·고지",season:"겨울(12~2월) 방문 최적",color:"#38BDF8",r:"56,189,248",detail:"깊고 고요한 수(水) 기운이 흐르는 도량입니다. 북쪽 음기 속에서 집중력과 통찰력이 한층 깊어지며, 학업·시험·지혜·직관을 기원하는 기도에 가장 강한 터입니다."}},_=ve[$.templeOhaeng],c=_?'<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:12px;"><div style="background:rgba('+_.r+",0.10);border:1px solid rgba("+_.r+',0.3);border-radius:10px;padding:10px 12px;"><div style="font-size:11px;color:rgba(255,255,255,0.4);margin-bottom:4px;">자연 환경</div><div style="font-size:13px;font-weight:800;color:'+_.color+';">'+_.env+'</div></div><div style="background:rgba('+_.r+",0.10);border:1px solid rgba("+_.r+',0.3);border-radius:10px;padding:10px 12px;"><div style="font-size:11px;color:rgba(255,255,255,0.4);margin-bottom:4px;">최적 방문 시기</div><div style="font-size:13px;font-weight:800;color:'+_.color+';">'+_.season+'</div></div></div><div style="font-size:13px;color:#CBD5E1;line-height:1.8;">'+_.detail+"</div>":'<p style="margin:0;">'+b[$.templeOhaeng]+"</p>";i+=M(j.ohaeng,B+" "+$.templeOhaeng+"(오행) 기운 · 환경",c)}if(e.reason&&(i+=M(j.reason,"✨ 나와의 인연 이유",'<p style="margin:0;">'+e.reason+"</p>")),k){const s=j.purpose;i+='<div class="ds-card" style="background:rgba('+s.r+",0.06);border:1px solid rgba("+s.r+",0.22);border-left:4px solid "+s.c+';border-radius:16px;padding:20px 20px 20px 22px;margin-bottom:12px;">',i+='<div style="font-size:14px;font-weight:800;color:'+s.c+";margin-bottom:12px;padding-bottom:10px;border-bottom:1px solid rgba("+s.r+',0.2);">🎯 기도 목적</div>',i+='<span style="display:inline-block;background:rgba('+s.r+",0.18);border:1.5px solid rgba("+s.r+",0.5);color:"+s.c+';border-radius:24px;padding:9px 26px;font-weight:800;font-size:16px;">'+k+"</span>",i+="</div>"}if(Array.isArray(C)&&C.length){var h='<div style="display:flex;flex-direction:column;gap:12px;">'+C.map(function(s,l){var x=s.split(":"),O=x.length>1?x[0]+":":"",v=x.length>1?x.slice(1).join(":").trim():s;return'<div style="display:flex;gap:10px;align-items:flex-start;"><span style="flex:0 0 auto;width:24px;height:24px;border-radius:50%;background:rgba(52,211,153,0.18);border:1.5px solid rgba(52,211,153,0.4);display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:900;color:#34D399;margin-top:1px;">'+(l+1)+'</span><div style="flex:1;">'+(O?'<span style="color:#34D399;font-weight:800;">'+O+"</span> ":"")+'<span style="color:#E2E8F0;">'+v+"</span></div></div>"}).join("")+"</div>";i+=M(j.guide,"🙏 이렇게 기도해보세요",h)}(function(){var s=$.templeOhaeng||"금",l=a&&a.weak&&a.weak.부족오행||s,x=$.name||"",O=$.history||"",v=x+" "+O,g={대웅전:!0};/관음/.test(x)&&(g.관음전=!0),/약사/.test(x)&&(g.약사전=!0),/지장/.test(x)&&(g.지장전=!0),/나한/.test(x)&&(g.나한전=!0),/미타|극락/.test(x)&&(g.극락전=!0),/문수/.test(x)&&(g.문수전=!0),/비로|화엄/.test(x)&&(g.비로전=!0),/관음도량|관음전/.test(v)&&(g.관음전=!0),/약사전|약사여래/.test(v)&&(g.약사전=!0),/지장전|지장보살/.test(v)&&(g.지장전=!0),/나한전|오백나한/.test(v)&&(g.나한전=!0),/극락전|미타전|아미타/.test(v)&&(g.극락전=!0),/문수전|문수보살/.test(v)&&(g.문수전=!0),/총림|본사|대가람|대사찰|대본사/.test(v)&&(g.관음전=!0,g.약사전=!0,g.나한전=!0,g.지장전=!0);var Y={대웅전:{icon:"🏛️",color:"#FBBF24"},관음전:{icon:"🌸",color:"#F472B6"},약사전:{icon:"💊",color:"#34D399"},나한전:{icon:"🙏",color:"#FB923C"},지장전:{icon:"🕯️",color:"#94A3B8"},극락전:{icon:"🌅",color:"#818CF8"},문수전:{icon:"📚",color:"#38BDF8"},비로전:{icon:"☀️",color:"#FCD34D"}},X={재물운:{must:["대웅전"],want:["나한전","관음전","지장전"]},건강운:{must:["대웅전"],want:["약사전","관음전","나한전"]},학업운:{must:["대웅전"],want:["문수전","나한전","관음전"]},인연운:{must:["대웅전"],want:["관음전","나한전","지장전"]},가정운:{must:["대웅전"],want:["관음전","지장전","나한전"]},수험합격:{must:["대웅전"],want:["나한전","문수전","관음전"]},취업운:{must:["대웅전"],want:["나한전","관음전","지장전"]},출산기도:{must:["대웅전"],want:["관음전","약사전","지장전"]}},U={수:"관음전",목:"약사전",화:"관음전",토:"지장전",금:"나한전"},K={재물운:"금",건강운:"목",학업운:"수",인연운:"화",가정운:"토",수험합격:"수",취업운:"금",출산기도:"목"},H={학업운:"문수전",수험합격:"문수전"},le=X[k];if(!le)return;var P=U[K[k]],G=[U[l],H[k],P,U[s]].concat(le.want).filter(function(ee,fe,je){return ee&&je.indexOf(ee)===fe}),oe=[],de=[];G.forEach(function(ee){g[ee]?oe.push(ee):de.push(ee)});var xe=le.must,we=oe.filter(function(ee){return xe.indexOf(ee)<0}),ye=xe.concat(we.slice(0,1)),$e=we.slice(1).concat(de).slice(0,2),De={대웅전:{재물운:'석가모니 부처님께 <strong style="color:#FBBF24;">삼배</strong>를 올리며 사업·재물의 번창을 발원합니다.',건강운:'나와 가족의 건강을 위해 <strong style="color:#FBBF24;">삼배</strong>와 함께 간절히 발원합니다.',학업운:'집중력·기억력이 높아지기를 <strong style="color:#FBBF24;">삼배</strong>로 발원합니다.',인연운:'좋은 인연이 이루어지도록 <strong style="color:#FBBF24;">삼배</strong>와 함께 진솔하게 발원합니다.',가정운:'가족 이름을 마음에 품고 <strong style="color:#FBBF24;">삼배</strong>로 가정의 평안을 발원합니다.',수험합격:'시험 날짜와 이름을 소원지에 적어 <strong style="color:#FBBF24;">삼배</strong>와 함께 올립니다.',취업운:'원하는 직장을 구체적으로 떠올리며 <strong style="color:#FBBF24;">삼배</strong>를 올립니다.',출산기도:'새 생명의 건강한 탄생을 위해 <strong style="color:#FBBF24;">삼배</strong>와 함께 발원합니다.'},관음전:{재물운:"관세음보살님께 자비로운 풍요와 기회를 열어달라고 발원합니다.",건강운:"관세음보살님의 치유 자비력으로 몸과 마음의 회복을 빕니다.",학업운:"관세음보살님께 지혜의 문이 열리기를 간청합니다.",인연운:"관음보살님은 인연의 보살. 좋은 만남이 이루어지도록 발원하세요.",가정운:"가족 모두의 건강과 화목을 관세음보살님께 빕니다.",수험합격:"시험장에서 침착하고 자신 있게 실력을 발휘할 수 있도록 빕니다.",취업운:"좋은 직장과의 인연이 열리도록 관세음보살님께 발원합니다.",출산기도:"관음보살님은 산모와 아기를 보살펴 주시는 분. 정성껏 발원하세요."},약사전:{재물운:"약사여래님의 지혜 기운으로 재물이 바르게 쌓이기를 발원합니다.",건강운:'약사여래 부처님께 <strong style="color:#34D399;">질병 치유와 건강 회복</strong>을 간절히 발원합니다.',학업운:"약사여래님의 맑은 기운으로 머리가 밝아지기를 빕니다.",인연운:"몸과 마음이 건강해야 좋은 인연도 옵니다. 건강 발원 후 인연을 비세요.",가정운:"가족 모두의 건강을 약사여래 부처님께 발원합니다.",수험합격:"시험 당일 컨디션이 최상이 되기를 약사여래님께 빕니다.",취업운:"건강한 몸과 마음으로 취업 준비에 임할 수 있도록 발원합니다.",출산기도:"산모와 아기의 건강을 약사여래 부처님께 특별히 발원하세요."},나한전:{재물운:"오백 나한님 중 내 소원을 들어줄 나한을 찾아 재물운을 빕니다.",건강운:"나한님께 나와 가족의 회복을 소원합니다. 내 이름을 불러주세요.",학업운:"오백 나한님 중 학업을 이뤄준 나한을 찾아 합격을 발원합니다.",인연운:"나한님께 좋은 인연을 맺어달라는 소원을 올립니다.",가정운:"가정의 평화를 이루어줄 나한님께 소원을 올립니다.",수험합격:"오백 나한님 중 합격을 도운 나한을 찾아 간절히 소원을 올립니다.",취업운:"취업의 기회를 열어줄 나한님께 소원을 올립니다.",출산기도:"새 생명을 맞이할 수 있도록 나한님께 소원을 올립니다."},지장전:{재물운:"지장보살님께 사업의 기반을 튼튼히 해달라고 발원합니다.",건강운:"조상과 가족의 업장을 소멸하여 건강이 회복되기를 빕니다.",학업운:"조상님의 가호로 학업이 이루어지기를 지장보살님께 발원합니다.",인연운:"인연의 장애를 풀어달라고 지장보살님께 발원합니다.",가정운:"조상과 가족 모두가 평안하도록 지장보살님께 발원합니다.",수험합격:"합격을 가로막는 업장이 소멸되기를 지장보살님께 빕니다.",취업운:"취업을 막는 장애가 사라지도록 지장보살님께 발원합니다.",출산기도:"순산과 아이의 안녕을 지장보살님께 발원합니다."},극락전:{재물운:"아미타 부처님의 자비 원력으로 풍요로운 삶을 발원합니다.",건강운:"아미타 부처님께 건강과 장수를 발원합니다.",학업운:"아미타 부처님의 지혜 광명이 학업에 비추기를 발원합니다.",인연운:"아미타 부처님의 원력으로 좋은 인연이 이루어지기를 빕니다.",가정운:"아미타 부처님께 가정의 평화와 행복을 발원합니다.",수험합격:"아미타 부처님의 원력으로 시험에서 실력 발휘를 발원합니다.",취업운:"아미타 부처님의 자비 원력으로 취업의 기회가 열리기를 빕니다.",출산기도:"아미타 부처님께 새 생명의 탄생을 발원합니다."},문수전:{학업운:"지혜의 문수보살님께 학업 성취와 총명함을 간절히 발원합니다.",수험합격:"문수보살님은 지혜의 상징. 시험 합격을 간절히 발원하세요.",취업운:"문수보살님의 지혜로 취업의 방향이 열리기를 발원합니다.",재물운:"문수보살님의 지혜로 바른 재물운이 열리기를 발원합니다.",건강운:"문수보살님의 지혜 기운으로 건강이 회복되기를 빕니다.",인연운:"지혜로운 문수보살님께 좋은 인연이 이루어지기를 발원합니다.",가정운:"문수보살님의 지혜로 가정이 화목해지기를 발원합니다.",출산기도:"문수보살님의 지혜 기운으로 건강한 아이가 태어나기를 빕니다."}};function Be(ee,fe,je){var Ae=Y[ee]||{icon:"🏯",color:"#94A3B8"},Se=De[ee]||{},Ce=Se[k]||ee+"에서 정성껏 기도를 올립니다.",Me=fe?'<span style="font-size:10px;background:rgba(148,163,184,0.2);color:#94A3B8;border-radius:4px;padding:2px 6px;margin-left:6px;vertical-align:middle;">있는 경우</span>':je?'<span style="font-size:10px;background:rgba(251,191,36,0.2);color:#FBBF24;border-radius:4px;padding:2px 6px;margin-left:6px;vertical-align:middle;">✦ 사주 인연 전각</span>':"",r=je?"rgba(251,191,36,0.4)":fe?"rgba(255,255,255,0.05)":"rgba(255,255,255,0.1)",I=je?"rgba(251,191,36,0.06)":"rgba(255,255,255,0.04)";return'<div style="display:flex;gap:12px;align-items:flex-start;background:'+I+";border-radius:12px;padding:12px 14px;border:1px solid "+r+";opacity:"+(fe?"0.7":"1")+';"><div style="flex:0 0 auto;width:40px;height:40px;border-radius:10px;background:rgba(255,255,255,0.07);display:flex;align-items:center;justify-content:center;font-size:20px;">'+Ae.icon+'</div><div style="flex:1;"><div style="font-size:14px;font-weight:800;color:'+Ae.color+';margin-bottom:4px;">'+ee+Me+'</div><div style="font-size:13px;color:#CBD5E1;line-height:1.6;">'+Ce+"</div></div></div>"}var ke={수:"水(수)",목:"木(목)",화:"火(화)",토:"土(토)",금:"金(금)"},ze={수:"관음보살님은 水의 자비 기운으로 지혜와 총명함을 주십니다.",목:"약사여래님은 木의 생명 기운으로 성장과 회복력을 주십니다.",화:"관음보살님의 慈悲(자비)는 火의 기운으로 인연과 교류를 열어줍니다.",토:"지장보살님은 土의 안정 기운으로 기반을 다지고 가정을 지켜주십니다.",금:"나한님들은 金의 기운으로 결단력·집중력·소원 성취를 도와주십니다."},q=U[l],be="",Ee=ke[K[k]]||"",Le=P||"";l&&ke[l]&&(be='<div style="background:linear-gradient(135deg,rgba(251,191,36,0.12),rgba(168,85,247,0.10));border:1px solid rgba(251,191,36,0.3);border-radius:14px;padding:14px 16px;margin-bottom:14px;"><div style="font-size:12px;color:#94A3B8;margin-bottom:8px;letter-spacing:0.5px;">🔮 사주 × 기도목적 분석</div><div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;"><span style="font-size:11px;color:#94A3B8;min-width:80px;">사주 부족오행</span><span style="color:#F9A8D4;font-weight:800;">'+ke[l]+'</span><span style="color:#64748B;">→</span><span style="color:#FDE68A;font-weight:800;">'+(q||"")+'</span><span style="font-size:10px;background:rgba(251,191,36,0.2);color:#FBBF24;border-radius:4px;padding:1px 5px;">인연 전각</span></div>'+(Ee?'<div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;"><span style="font-size:11px;color:#94A3B8;min-width:80px;">'+k+' 오행</span><span style="color:#93C5FD;font-weight:800;">'+Ee+'</span><span style="color:#64748B;">→</span><span style="color:#BAE6FD;font-weight:800;">'+Le+"</span></div>":"")+'<div style="font-size:12px;color:#94A3B8;border-top:1px solid rgba(255,255,255,0.07);padding-top:8px;line-height:1.6;">'+(ze[l]||"부족한 기운을 보충하는 전각에서 기도하세요.")+"</div></div>");var o=be+'<div style="display:flex;flex-direction:column;gap:10px;">';ye.forEach(function(ee){var fe=ee===q&&ee!=="대웅전";o+=Be(ee,!1,fe)}),$e.forEach(function(ee){o+=Be(ee,!0,!1)}),o+="</div>",i+=M({r:"251,191,36",c:"#FBBF24"},"🏯 방문할 전각 안내",o)})(),function(){var s=[{icon:"🙏",label:"삼배 방법",color:"#34D399",desc:'<strong style="color:#34D399;">합장(두 손 모음)</strong> 후 무릎을 꿇고 이마를 바닥에 댑니다. 총 세 번 반복 — 불(佛)·법(法)·승(僧) 삼보에 귀의하는 예입니다.'},{icon:"👘",label:"복장",color:"#818CF8",desc:'<strong style="color:#818CF8;">단정한 복장</strong>을 권장합니다. 민소매·짧은 반바지는 피하고, 실내 전각 입장 시 모자를 벗으세요.'},{icon:"🤫",label:"경내 예절",color:"#38BDF8",desc:'<strong style="color:#38BDF8;">사진 촬영</strong>은 스님이나 안내판을 확인 후 허용된 곳에서만. 목소리를 낮추고 뛰지 않습니다.'},{icon:"🧎",label:"스님 만남",color:"#F472B6",desc:'스님께는 <strong style="color:#F472B6;">합장 반배(고개를 30° 숙임)</strong>로 인사드립니다. 악수보다 합장이 예의입니다.'},{icon:"🕯️",label:"소원지·불전",color:"#FBBF24",desc:'<strong style="color:#FBBF24;">소원지</strong>는 이름·생년월일·소원을 적어 담당 스님 혹은 지정함에 제출합니다. 불전함(헌금)은 자유입니다.'}],l=[{icon:"🌅",label:"새벽 예불",color:"#FB923C",desc:'보통 <strong style="color:#FB923C;">새벽 4~5시</strong>에 진행됩니다. 일반인도 조용히 참관 가능하며, 하루 중 가장 청정한 기운을 받을 수 있습니다.'},{icon:"🍚",label:"사찰 공양",color:"#34D399",desc:'일부 사찰에서 <strong style="color:#34D399;">점심 공양(무료 또는 소액)</strong>을 제공합니다. 방문 전 전화로 확인하고 감사한 마음으로 참여하세요.'},{icon:"📿",label:"108배",color:"#818CF8",desc:'<strong style="color:#818CF8;">108번의 절</strong>은 108가지 번뇌를 끊는 수행입니다. 법당 한편에서 매트를 빌려 할 수 있는 사찰도 있습니다.'},{icon:"🌿",label:"템플스테이",color:"#38BDF8",desc:'1박 이상 머물며 스님과 함께 생활하는 <strong style="color:#38BDF8;">템플스테이</strong>를 운영하는 사찰이 많습니다. 한국불교문화사업단 앱에서 예약 가능합니다.'}],x='<div style="display:flex;flex-direction:column;gap:10px;">'+s.map(function(v){return'<div style="display:flex;gap:10px;align-items:flex-start;"><div style="flex:0 0 auto;width:32px;height:32px;border-radius:8px;background:rgba(255,255,255,0.06);display:flex;align-items:center;justify-content:center;font-size:16px;margin-top:1px;">'+v.icon+'</div><div style="flex:1;"><div style="font-size:13px;font-weight:800;color:'+v.color+';margin-bottom:3px;">'+v.label+'</div><div style="font-size:13px;color:#CBD5E1;line-height:1.6;">'+v.desc+"</div></div></div>"}).join("")+"</div>",O='<div style="display:flex;flex-direction:column;gap:10px;">'+l.map(function(v){return'<div style="display:flex;gap:10px;align-items:flex-start;"><div style="flex:0 0 auto;width:32px;height:32px;border-radius:8px;background:rgba(255,255,255,0.06);display:flex;align-items:center;justify-content:center;font-size:16px;margin-top:1px;">'+v.icon+'</div><div style="flex:1;"><div style="font-size:13px;font-weight:800;color:'+v.color+';margin-bottom:3px;">'+v.label+'</div><div style="font-size:13px;color:#CBD5E1;line-height:1.6;">'+v.desc+"</div></div></div>"}).join("")+"</div>";i+=M({r:"52,211,153",c:"#34D399"},"🙏 기도 예절",x),i+=M({r:"251,191,36",c:"#FBBF24"},"💡 방문 팁",O)}();const E=k?{재물운:function(s){return s+` 삼보님께 귀의합니다.
...
나무관세음보살.`}}[k]:null;if(E){const s=E(m.name||"이 사찰"),l=j.gido;f?(i+='<div class="ds-card" style="background:rgba('+l.r+",0.07);border:1px solid rgba("+l.r+",0.25);border-left:4px solid "+l.c+';border-radius:16px;padding:20px 20px 20px 22px;margin-bottom:12px;">',i+='<div style="font-size:14px;font-weight:800;color:'+l.c+";margin-bottom:12px;padding-bottom:10px;border-bottom:1px solid rgba("+l.r+',0.2);">🕯️ 맞춤 기도문</div>',i+='<div style="font-size:14px;color:#E2E8F0;line-height:2.1;white-space:pre-line;background:rgba(0,0,0,0.2);border-radius:12px;padding:16px;">'+s+"</div>",i+='<button id="gido-copy-btn" style="margin-top:14px;display:inline-flex;align-items:center;gap:6px;background:rgba('+l.r+",0.15);border:1px solid rgba("+l.r+",0.4);color:"+l.c+';border-radius:14px;padding:9px 20px;font-size:13px;font-weight:700;cursor:pointer;">📋 기도문 복사</button>',i+='<textarea id="gido-raw" style="position:absolute;left:-9999px;opacity:0;" readonly>'+s+"</textarea>",i+="</div>"):(i+='<div class="ds-card" style="background:rgba('+l.r+",0.07);border:1px solid rgba("+l.r+",0.25);border-left:4px solid "+l.c+';border-radius:16px;padding:20px 20px 20px 22px;margin-bottom:12px;">',i+='<div style="font-size:14px;font-weight:800;color:'+l.c+";margin-bottom:12px;padding-bottom:10px;border-bottom:1px solid rgba("+l.r+',0.2);">🕯️ 맞춤 기도문</div>',i+='<div style="font-size:14px;color:#94A3B8;line-height:2;background:rgba(0,0,0,0.2);border-radius:12px;padding:16px;filter:blur(2px);pointer-events:none;">'+s.slice(0,80)+"…</div>",i+='<div style="margin-top:14px;text-align:center;font-size:15px;font-weight:800;color:#1A1200;background:#FCD34D;border-radius:10px;padding:12px 16px;letter-spacing:.03em;">🔒 전체 기도문은 멤버십 전용입니다</div>',i+="</div>")}if(i+='<div id="history-section">'+(T?'<div class="ds-card" style="background:rgba(217,119,6,0.06);border:1px solid rgba(217,119,6,0.22);border-left:4px solid #D97706;border-radius:16px;padding:20px 20px 20px 22px;margin-bottom:12px;"><div style="font-size:14px;font-weight:800;color:#D97706;margin-bottom:12px;padding-bottom:10px;border-bottom:1px solid rgba(217,119,6,0.2);">📜 유래 · 연혁</div><div id="history-body" style="font-size:14px;color:#E2E8F0;line-height:1.9;"><p style="margin:0;">'+ie+"</p></div></div>":"")+"</div>",u.length>0){const s=j.date,l=["일","월","화","수","목","금","토"],x=u.slice(0,V).map(function(O){const v=O.date.split("-"),g=parseInt(v[1]),Y=parseInt(v[2]),X=new Date(parseInt(v[0]),g-1,Y).getDay(),U=l[X],K=X===0||X===6,H=O.dayOhaeng&&W[O.dayOhaeng[0]]||"✶",le=O.dayOhaeng&&t[O.dayOhaeng[0]]||t.금;return'<div class="detail-date-card" style="display:inline-flex;flex-direction:column;align-items:center;gap:5px;background:rgba('+le.r+",0.1);border:1px solid rgba("+le.r+',0.35);border-radius:16px;padding:14px 18px;margin:4px;min-width:74px;"><span style="font-size:20px;">'+H+'</span><span style="font-size:17px;font-weight:900;color:'+le.c+';">'+g+"/"+Y+'</span><span style="font-size:12px;color:'+(K?"#F87171":"rgba(255,255,255,0.6)")+';font-weight:600;">('+U+")</span>"+(O.dayOhaeng?'<span style="font-size:10px;color:'+le.c+';font-weight:700;">'+Array.from(O.dayOhaeng).join("·")+"일</span>":"")+"</div>"}).join("");i+='<div class="ds-card" style="background:rgba('+s.r+",0.06);border:1px solid rgba("+s.r+",0.22);border-left:4px solid "+s.c+';border-radius:16px;padding:20px 20px 20px 22px;margin-bottom:12px;">',i+='<div style="font-size:14px;font-weight:800;color:'+s.c+";margin-bottom:12px;padding-bottom:10px;border-bottom:1px solid rgba("+s.r+',0.2);">📅 추천 방문 날짜'+(f?"":'<span style="font-size:11px;font-weight:400;opacity:.45;margin-left:8px;">상위 3일 · 전체는 멤버 전용</span>')+"</div>",i+='<div style="display:flex;flex-wrap:wrap;gap:2px;">'+x+"</div>",!f&&u.length>=3&&(i+='<div style="margin-top:12px;font-size:12px;color:rgba(255,255,255,0.35);text-align:center;">🔒 멤버십 회원은 최대 15일 추천 날짜 제공</div>'),i+="</div>"}if(Object.keys(N).length>0){const s=j.dist,l=Object.entries(N).map(function([x,O]){const v=x===$.templeOhaeng,g=t[x]||t.금;return'<div style="display:inline-flex;align-items:center;gap:6px;padding:8px 18px;border-radius:24px;margin:4px;font-weight:800;font-size:14px;background:rgba('+g.r+","+(v?"0.18":"0.07")+");border:1.5px solid rgba("+g.r+","+(v?"0.55":"0.2")+");color:"+(v?g.c:"rgba(255,255,255,0.55)")+";"+(v?"box-shadow:0 0 14px rgba("+g.r+",0.25);":"")+'">'+(W[x]||"")+" "+x+" "+O+(v?" ✦":"")+"</div>"}).join("");i+='<div class="ds-card" style="background:rgba('+s.r+",0.06);border:1px solid rgba("+s.r+",0.22);border-left:4px solid "+s.c+';border-radius:16px;padding:20px 20px 20px 22px;margin-bottom:12px;">',i+='<div style="font-size:14px;font-weight:800;color:'+s.c+";margin-bottom:12px;padding-bottom:10px;border-bottom:1px solid rgba("+s.r+',0.2);">🔥 나의 사주 오행 분포</div>',i+='<div style="display:flex;flex-wrap:wrap;gap:2px;margin-bottom:10px;">'+l+"</div>";var y=a?a.weak&&a.weak.부족오행:null,re=y&&y===$.templeOhaeng?'✦ 내 사주에서 가장 부족한 <b style="color:'+w+';">'+$.templeOhaeng+"</b> 기운을 이 사찰이 채워줍니다.":'✦ 이 사찰의 기운은 <b style="color:'+w+';">'+($.templeOhaeng||"")+"</b>으로, 선택하신 기도목적("+(k||"—")+")에 최적화된 도량입니다.";i+='<div style="font-size:12px;color:rgba(255,255,255,0.4);line-height:1.7;margin-top:6px;">'+re+"</div>",i+="</div>"}f||(i+='<div style="background:rgba(212,175,55,0.06);border:1px solid rgba(212,175,55,0.3);border-radius:16px;padding:28px 20px;margin-bottom:12px;text-align:center;">',i+='<div style="font-size:30px;margin-bottom:10px;">🔒</div>',i+='<div style="font-size:16px;font-weight:800;color:#D4AF37;margin-bottom:8px;">멤버십 전용 콘텐츠</div>',i+='<div style="font-size:13px;color:rgba(255,255,255,0.5);margin-bottom:18px;">유래 전문 · 추천 날짜 전체 · 기도문 전체 &amp; 복사</div>',i+='<div class="member-unlock"><input type="text" id="detail-member-code-input" placeholder="멤버십 코드 입력" /><button id="detail-member-code-btn">확인</button></div>',i+="</div>"),i+='<div class="patent-notice-banner" style="margin-bottom:12px;"><div class="patent-notice-icon">⚖️</div><div class="patent-notice-body"><div class="patent-notice-title">지식재산권 안내</div><div class="patent-notice-text">본 서비스의 <strong>인연 시너지 산출 로직</strong>은 비가산 시너지 기반 지수 산출 방식을 적용한 독자 기술입니다.</div><span class="patent-num">특허 출원 중 (출원번호: 40-2026-00*****)</span></div></div>',i+="</div>",z.innerHTML=i,function(){const l=m.name;if(!l)return;const x=document.getElementById("detail-hero-img"),O=document.getElementById("detail-hero-overlay"),v=document.getElementById("detail-hero");if(!x||!O)return;function g(P){if(!P)return!1;var G=P.toLowerCase();if(!/\.(jpe?g)/i.test(G))return!1;var oe=["flag","taegeuk","taeguk","portrait","map","document","signature","seal","coin","stamp","symbol","logo","icon","graph","chart","diagram","hangeul","hangul","korean_language","korea_map","location","emblem","crest","arms","건물","도로","지도","교통","버스","지하철","아파트"];return!oe.some(function(de){return G.indexOf(de)!==-1})}function Y(P){var G=new Image;G.onload=function(){G.naturalWidth<300||G.naturalHeight<200||(x.style.backgroundImage="url("+P+")",x.style.opacity="1",O.style.opacity="1",v&&(v.style.background="none"),x.style.cursor="zoom-in",x.onclick=function(){var oe=document.createElement("div");oe.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.92);z-index:99999;display:flex;align-items:center;justify-content:center;cursor:zoom-out;";var de=new Image;de.src=P,de.style.cssText="max-width:92vw;max-height:88vh;border-radius:12px;box-shadow:0 8px 48px #000;",oe.appendChild(de),oe.onclick=function(){document.body.removeChild(oe)},document.body.appendChild(oe)})},G.src=P}var X={목:"linear-gradient(160deg,rgba(34,85,34,0.85) 0%,rgba(20,60,20,0.95) 100%)",화:"linear-gradient(160deg,rgba(120,40,10,0.85) 0%,rgba(80,20,5,0.95) 100%)",토:"linear-gradient(160deg,rgba(90,70,20,0.85) 0%,rgba(60,45,10,0.95) 100%)",금:"linear-gradient(160deg,rgba(90,70,10,0.85) 0%,rgba(60,45,5,0.95) 100%)",수:"linear-gradient(160deg,rgba(10,40,80,0.85) 0%,rgba(5,20,60,0.95) 100%)"};function U(){var P=$.templeOhaeng||"금",G=X[P]||X.금;v&&(v.style.background=G)}function K(P){return fetch("https://commons.wikimedia.org/w/api.php?action=query&list=search&srsearch="+encodeURIComponent(P)+"&srnamespace=6&srlimit=10&srprop=&format=json&origin=*").then(function(G){return G.ok?G.json():null}).then(function(G){if(!G||!G.query||!G.query.search)return[];var oe=G.query.search.map(function(xe){return xe.title}).filter(function(xe){return/\.jpe?g$/i.test(xe)}).slice(0,8);if(!oe.length)return[];var de=oe.map(encodeURIComponent).join("%7C");return fetch("https://commons.wikimedia.org/w/api.php?action=query&prop=imageinfo&iiprop=url%7Csize&iiurlwidth=900&titles="+de+"&format=json&origin=*").then(function(xe){return xe.ok?xe.json():null}).then(function(xe){if(!xe)return[];var we=xe.query&&xe.query.pages?xe.query.pages:{};return Object.values(we).map(function(ye){return ye.imageinfo&&ye.imageinfo[0]}).filter(function(ye){return ye&&ye.thumburl&&g(ye.thumburl)&&(ye.width||0)>=400&&(ye.height||0)>=300})})}).catch(function(){return[]})}var H=!1;function le(P){return H||!P||!P.length?!1:(H=!0,Y(P[0].thumburl),!0)}fetch("https://ko.wikipedia.org/w/api.php?action=query&prop=pageimages|info&pithumbsize=900&titles="+encodeURIComponent(l)+"&format=json&origin=*").then(function(P){return P.ok?P.json():null}).then(function(P){if(!H&&P){var G=P.query&&P.query.pages?P.query.pages:{},oe=Object.values(G)[0];if(!(!oe||oe.missing!==void 0)){var de=oe.thumbnail?oe.thumbnail.source:null;de&&g(de)&&(H=!0,Y(de))}}}).catch(function(){}),setTimeout(function(){H||Promise.all([K(l+" 사찰"),K(l+" temple Korea")]).then(function(P){if(!H){var G=[].concat(P[0],P[1]);if(!le(G)){var oe=(m.address||"").split(" ").slice(0,2).join(" ");return oe?K(oe+" 불교 사찰"):Promise.resolve([])}}}).then(function(P){H||!P||le(P)||U()}).catch(function(){H||U()})},800)}(),function(){var l=document.getElementById("temple-gallery"),x=document.getElementById("gallery-scroll");if(!l||!x||!m.name)return;function O(g){if(!(!g||g.length===0)){var Y=g.map(function(X){var U=X.thumburl,K=U.replace(/\/\d+px-/,"/1200px-");return`<div style="flex:0 0 auto;width:160px;height:110px;border-radius:12px;overflow:hidden;border:1px solid rgba(255,255,255,0.12);cursor:pointer;transition:transform .2s,box-shadow .2s;" onmouseover="this.style.transform='scale(1.04)';this.style.boxShadow='0 6px 20px rgba(0,0,0,.5)'" onmouseout="this.style.transform='';this.style.boxShadow=''" data-src="`+K+`" onclick="(function(u){var ov=document.createElement('div');ov.style.cssText='position:fixed;inset:0;background:rgba(0,0,0,.9);z-index:99999;display:flex;align-items:center;justify-content:center;cursor:zoom-out;';var im=new Image();im.src=u;im.style.cssText='max-width:92vw;max-height:88vh;border-radius:10px;box-shadow:0 8px 40px #000;';ov.appendChild(im);ov.onclick=function(){document.body.removeChild(ov);};document.body.appendChild(ov);})(this.dataset.src)"><img src="`+U+`" style="width:100%;height:100%;object-fit:cover;" loading="lazy" onerror="this.parentElement.style.display='none'"></div>`}).join("");x.innerHTML=Y,l.style.display="block"}}function v(g,Y){var X=Y.map(function(U){return encodeURIComponent(U)}).join("%7C");return fetch(g+"?action=query&prop=imageinfo&iiprop=url%7Csize&iiurlwidth=500&titles="+X+"&format=json&origin=*").then(function(U){return U.ok?U.json():null}).then(function(U){if(!U)return[];var K=U.query&&U.query.pages?U.query.pages:{};return Object.values(K).map(function(H){return H.imageinfo&&H.imageinfo[0]}).filter(function(H){if(!H||!H.thumburl||!/\.(jpe?g)/i.test(H.thumburl)||(H.width||0)<400||(H.height||0)<300)return!1;var le=H.thumburl.toLowerCase(),P=["taegeuk","taeguk","flag","portrait","map","document","signature","seal","coin","stamp","symbol","logo","icon","graph","chart","diagram","hangeul","hangul","emblem","crest","location","korea_map","korean_language","태극","지도","문서","초상","건물","도로","교통"];if(P.some(function(oe){return le.indexOf(oe)!==-1}))return!1;var G=(H.width||1)/(H.height||1);return!(G<.5||G>3.5)})})}fetch("https://ko.wikipedia.org/w/api.php?action=query&prop=pageprops&titles="+encodeURIComponent(m.name)+"&format=json&origin=*").then(function(g){return g.ok?g.json():null}).then(function(g){var Y=g&&g.query&&g.query.pages?g.query.pages:{},X=Object.values(Y)[0],U=X&&X.pageprops&&X.pageprops.commonsCategory;return U?fetch("https://commons.wikimedia.org/w/api.php?action=query&list=categorymembers&cmtitle="+encodeURIComponent("Category:"+U)+"&cmtype=file&cmlimit=20&format=json&origin=*").then(function(K){return K.ok?K.json():null}).then(function(K){if(!K||!K.query)return null;var H=(K.query.categorymembers||[]).map(function(le){return le.title}).filter(function(le){return/\.jpe?g$/i.test(le)}).slice(0,10);return H.length?v("https://commons.wikimedia.org/w/api.php",H):null}):null}).then(function(g){return g&&g.length>=1?(O(g),Promise.resolve(!0)):fetch("https://commons.wikimedia.org/w/api.php?action=query&list=search&srsearch="+encodeURIComponent(m.name+" temple")+"&srnamespace=6&srlimit=16&srprop=&format=json&origin=*").then(function(Y){return Y.ok?Y.json():null}).then(function(Y){if(!Y||!Y.query||!Y.query.search)return null;var X=Y.query.search.map(function(U){return U.title}).filter(function(U){return/\.jpe?g$/i.test(U)}).slice(0,10);return X.length?v("https://commons.wikimedia.org/w/api.php",X):null})}).then(function(g){if(g===!0||g&&g.length>=1){g!==!0&&O(g);return}return fetch("https://ko.wikipedia.org/w/api.php?action=query&prop=images&titles="+encodeURIComponent(m.name)+"&imlimit=20&format=json&origin=*").then(function(Y){return Y.ok?Y.json():null}).then(function(Y){if(Y){var X=Y.query&&Y.query.pages?Y.query.pages:{},U=Object.values(X)[0];if(!(!U||!U.images)){var K=U.images.map(function(H){return H.title}).filter(function(H){return/\.jpe?g$/i.test(H)}).slice(0,10);if(K.length)return v("https://ko.wikipedia.org/w/api.php",K).then(function(H){H&&H.length>=1&&O(H)})}}})}).catch(function(){})}(),function(){if(m.name){var l=document.getElementById("history-section");document.getElementById("history-body"),!(T.length>=150)&&fetch("https://ko.wikipedia.org/w/api.php?action=query&prop=extracts&exintro=1&explaintext=1&exsentences=6&titles="+encodeURIComponent(m.name)+"&format=json&origin=*").then(function(x){return x.ok?x.json():null}).then(function(x){if(x){var O=x.query&&x.query.pages?x.query.pages:{},v=Object.values(O)[0],g=v&&v.extract?v.extract.trim():"";if(!(!g||g.length<30)&&l){var Y=(T?T+`

`:"")+g,X=f?Y:Y.slice(0,200)+(Y.length>200?'… <span style="color:rgba(255,255,255,0.35);font-size:12px;">🔒 전체보기는 멤버 전용</span>':"");l.innerHTML='<div class="ds-card" style="background:rgba(217,119,6,0.06);border:1px solid rgba(217,119,6,0.22);border-left:4px solid #D97706;border-radius:16px;padding:20px 20px 20px 22px;margin-bottom:12px;"><div style="font-size:14px;font-weight:800;color:#D97706;margin-bottom:12px;padding-bottom:10px;border-bottom:1px solid rgba(217,119,6,0.2);">📜 유래 · 연혁 <span style="font-size:11px;font-weight:400;opacity:.45;margin-left:6px;">위키백과 참조</span></div><div style="font-size:14px;color:#E2E8F0;line-height:1.9;white-space:pre-line;">'+X+"</div></div>"}}}).catch(function(){})}}();const pe=document.getElementById("gido-copy-btn"),ge=document.getElementById("gido-raw");pe&&ge&&pe.addEventListener("click",function(){navigator.clipboard.writeText(ge.value).then(function(){pe.textContent="✓ 복사됨!",setTimeout(function(){pe.innerHTML="📋 기도문 복사"},2e3)}).catch(function(){ge.select(),document.execCommand("copy")})}),(me=document.getElementById("detail-back-btn"))==null||me.addEventListener("click",()=>{var s;typeof S=="function"?S():(z.innerHTML="",z.classList.add("hidden"),p&&(p.style.display=""),(s=document.getElementById("app"))==null||s.scrollIntoView({behavior:"smooth",block:"start"}))});const ue=document.getElementById("detail-member-code-btn"),ae=document.getElementById("detail-member-code-input");ue&&ue.addEventListener("click",()=>{ae&&ae.value.trim()===Ge?(Re(ae.value.trim()),Ie(e,a,!0,S)):alert("코드가 올바르지 않습니다.")})}function Pe(e){var $,n;const a=document.getElementById("results");a.classList.remove("hidden");const f=(e.results||[])[0],S=it[($=f==null?void 0:f.detail)==null?void 0:$.bearing]??0,z=_e();a.innerHTML=`
    <div class="results-summary">
      <div class="label">나의 기운은</div>
      <div class="ohaeng-value">${e.targetOhaeng||""} 기운</div>
      <div class="ohaeng-breakdown">
        ${Object.entries(e.distribution||{}).map(([t,F])=>`${t} ${F}`).join(" · ")}
      </div>
    </div>
    ...
    ${(e.results||[]).map((t,F)=>{var w;return`
      <div class="temple-card" style="--accent: ${tt[(w=t.detail)==null?void 0:w.templeOhaeng]||"var(--gold)"}; animation-delay: ${.15+F*.08}s;">
        <div class="temple-rank">${F+1}</div>
        <div class="temple-body">
          ...
          ${t.temple.history?`
            <div class="temple-detail">
              ...
              <div class="temple-detail-text">
                ${z?t.temple.history:t.temple.history.length>35?`${t.temple.history.slice(0,35)}… <span class="member-lock-tag">🔒 전체보기는 멤버 전용</span>`:t.temple.history}
              </div>
          ...
          <button type="button" class="detail-view-btn" data-temple-index="${F}">상세페이지 보기 →</button>
        </div>
      </div>
    `}).join("")}
        ...
        <div style="display:flex;flex-direction:column;gap:10px;">
          ${e.recommendedDates.map((t,F)=>`
            <div style="display:flex;align-items:center;gap:12px;background:rgba(0,210,255,0.07);border:1px solid rgba(0,210,255,0.2);border-radius:12px;padding:12px 16px;">
              <div style="min-width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,#00b4d8,#0077b6);display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:800;color:#fff;">${F+1}</div>
              <div>
  ...
  `;const p=document.getElementById("member-code-input"),m=document.getElementById("member-code-btn");m&&m.addEventListener("click",()=>{p&&p.value.trim()===Ge?(Re(p.value.trim()),Pe(e)):alert("코드가 올바르지 않습니다.")}),document.querySelectorAll(".detail-view-btn").forEach(t=>{t.addEventListener("click",()=>{const F=parseInt(t.dataset.templeIndex);Ie(e.results[F],e,z)})}),function(){var b,B,N,k;var F=(b=e.results)==null?void 0:b[0],w=((B=F==null?void 0:F.temple)==null?void 0:B.name)||"인연사찰",d=(F==null?void 0:F.score)||"",j=e.purpose||"",M="https://jamgong-inyeonsachal.vercel.app",W='🏯 나의 인연사찰은 "'+w+`"!
오행 궁합 `+d+"점 매칭 ("+j+`)

내 사주에 맞는 사찰을 찾아보세요 👇
`+M,ne="내 인연사찰은 "+w+"! — 잼공인연사찰";(N=document.getElementById("share-kakao-btn"))==null||N.addEventListener("click",function(){var C;window.Kakao&&window.Kakao.isInitialized()?window.Kakao.Share.sendDefault({objectType:"feed",content:{title:ne,description:"오행 궁합 "+d+"점 매칭 ("+j+`)
내 사주에 맞는 사찰을 찾아보세요!`,imageUrl:"https://jamgong-inyeonsachal.vercel.app/og-image.png",link:{mobileWebUrl:M,webUrl:M}},buttons:[{title:"내 인연사찰 찾기",link:{mobileWebUrl:M,webUrl:M}}]}):navigator.share?navigator.share({title:ne,text:W,url:M}).catch(function(){}):(C=navigator.clipboard)==null||C.writeText(W).then(function(){alert(`카카오톡에 붙여넣기 하세요!

`+W)})}),(k=document.getElementById("share-copy-btn"))==null||k.addEventListener("click",function(){var u;var C=document.getElementById("share-copy-btn");(u=navigator.clipboard)==null||u.writeText(M).then(function(){C&&(C.textContent="✅ 복사됨!",setTimeout(function(){C.innerHTML="🔗 링크 복사"},2e3))}).catch(function(){alert("주소: "+M)})})}(),(n=document.getElementById("demo-detail-btn"))==null||n.addEventListener("click",()=>{Ie({score:94,reason:"수(水) 기운이 부족한 사주에 이 사찰의 강한 수 기운이 보완해줍니다.",temple:{name:"통도사",address:"경상남도 양산시 하북면 통도사로 108",lat:35.489166,lng:129.058611,foundedYear:646},detail:{templeOhaeng:"수",bearing:"북",distanceKm:12.3},weather:{condition:"맑음",temp:24}},{purpose:"학업운",distribution:{목:1,화:2,토:2,금:2,수:1},purposeGuide:[]},!0)}),a.scrollIntoView({behavior:"smooth"})}function at(e,a){const f={목:"화",화:"토",토:"금",금:"수",수:"목"},S={목:"토",토:"수",수:"화",화:"금",금:"목"},z={목:"木",화:"火",토:"土",금:"金",수:"水"},p={목:"#64DCA0",화:"#FF6B9D",토:"#FB923C",금:"#FFB347",수:"#00D2FF"};let m,$,n,t,F,w;const d=f[e]===a,j=f[a]===e,M=S[e]===a,W=S[a]===e;return d||j?(m=88,$="상생(相生)",n="천생연분(天生緣分)",t="#00D2FF",F="0,210,255",w="오행이 서로를 생(生)해주는 가장 이상적인 조합입니다. 단, 한쪽이 지나치게 의존하면 소진될 수 있습니다."):e===a?(m=68,$="비화(比和)",n="동질형(同質型)",t="#9FE5C4",F="159,229,196",w="같은 오행으로 서로를 잘 이해하지만, 동일한 약점을 함께 지닙니다. 외부 자극 없이는 정체될 수 있습니다."):M||W?(m=42,$="상극(相剋)",n="갈등형(葛藤型)",t="#F5A623",F="245,166,35",w="오행이 서로를 극(克)합니다. 긴장과 갈등이 잦을 수 있으며, 의식적인 노력 없이는 관계가 소모적이 될 수 있습니다."):(m=62,$="중화(中和)",n="평범형(平凡型)",t="#FF6B9D",F="255,107,157",w="특별히 맞거나 부딪히는 기운이 없는 평이한 조합입니다. 큰 시너지보다는 무난한 관계가 됩니다."),{score:m,relation:$,grade:n,color:t,rgb:F,comment:w,symA:z[e]||e,symB:z[a]||a,colA:p[e]||"#fff",colB:p[a]||"#fff"}}function lt(e){var q,be,Ee,Le,o,ee,fe,je,Ae,Se,Ce,Me;const a=document.getElementById("results");a.classList.remove("hidden");const f=_e(),S=((Ee=(be=(q=e.pillarsA)==null?void 0:q[2])==null?void 0:be.wx)==null?void 0:Ee[0])||e.targetA,z=((ee=(o=(Le=e.pillarsB)==null?void 0:Le[2])==null?void 0:o.wx)==null?void 0:ee[0])||e.targetB,p=at(S,z),m=(e.hapChung||[]).filter(r=>r.positive).length,$=(e.hapChung||[]).filter(r=>!r.positive).length,n=m*4-$*7,t=Math.max(10,Math.min(99,p.score+n)),F=Math.round(t);window._sajuContext=null,window._gunghamContext={pillarsA:e.pillarsA,pillarsB:e.pillarsB,hapChung:e.hapChung,distributionA:e.distributionA,distributionB:e.distributionB,genderA:e.genderA,genderB:e.genderB,targetA:S,targetB:z,finalScore:t,relation:p.relation,grade:p.grade};const w={목:"#64DCA0",화:"#FF6B9D",토:"#FB923C",금:"#FFB347",수:"#00D2FF"},d={목:"木",화:"火",토:"土",금:"金",수:"水"};function j(r,I,R){return!r||r.length===0?"":`
    <div class="gh-pillar-col">
      <div class="gh-pillar-label" style="color:${R}">${I}</div>
      <table class="gh-saju-table">
        <thead><tr>${["년","월","일","시"].map(Q=>`<th>${Q}</th>`).join("")}</tr></thead>
        <tbody>
          <tr class="gh-row-stem">${r.map(Q=>{var he;return`<td style="color:${w[(he=Q.wx)==null?void 0:he[0]]||"#fff"}">${Q.stem||""}</td>`}).join("")}</tr>
          <tr class="gh-row-branch">${r.map(Q=>{var he,Fe;return`<td style="color:${w[((he=Q.wx)==null?void 0:he[1])||((Fe=Q.wx)==null?void 0:Fe[0])]||"rgba(255,255,255,0.6)"}">${Q.branch||""}</td>`}).join("")}</tr>
          <tr class="gh-row-wx">${r.map(Q=>`<td>${(Q.wx||[]).map(ce=>`<span style="color:${w[ce]||"#fff"}">${d[ce]||ce}</span>`).join("")}</td>`).join("")}</tr>
        </tbody>
      </table>
    </div>`}const M={甲己:{name:"중정합(中正合)",wx:"土",desc:"안정적이고 현실적인 결합입니다. 서로를 믿고 의지하는 관계로 장기적인 신뢰가 형성됩니다."},乙庚:{name:"인의합(仁義合)",wx:"金",desc:"원칙과 의리로 맺어진 관계입니다. 한 번 인연이 맺어지면 쉽게 끊어지지 않습니다."},丙辛:{name:"위제합(威制合)",wx:"水",desc:"강렬한 끌림의 결합입니다. 서로에게 매력을 느끼고 지략과 감각이 맞닿는 관계입니다."},丁壬:{name:"인수합(仁壽合)",wx:"木",desc:"인정 넘치고 창의적인 결합입니다. 감성이 잘 맞아 함께 성장하는 인연입니다."},戊癸:{name:"무정합(無情合)",wx:"火",desc:"열정적이고 활기찬 결합입니다. 역동적인 에너지를 서로에게서 끌어냅니다."}},W={子丑:{desc:"자축합(子丑合)으로 土의 기운이 생깁니다. 안정적이고 묵묵하게 함께하는 관계입니다."},寅亥:{desc:"인해합(寅亥合)으로 木의 기운이 생깁니다. 서로 성장을 돕는 따뜻한 인연입니다."},卯戌:{desc:"묘술합(卯戌合)으로 火의 기운이 생깁니다. 열정적인 감정의 교류가 있는 관계입니다."},辰酉:{desc:"진유합(辰酉合)으로 金의 기운이 생깁니다. 단단하고 현실적인 결합입니다."},巳申:{desc:"사신합(巳申合)으로 水의 기운이 생깁니다. 지략과 변화 속에서 교류하는 인연입니다."},午未:{desc:"오미합(午未合)으로 태양의 조화입니다. 가장 자연스럽고 따뜻한 결합 중 하나입니다."}},ne={甲庚:"갑경충(甲庚沖)입니다. 추진 방향이 정반대여서 충돌이 발생합니다. 한쪽이 밀면 다른 쪽이 버티는 구조입니다.",乙辛:"을신충(乙辛沖)입니다. 섬세한 감성과 날카로운 이성이 부딪힙니다. 표현 방식의 차이에서 갈등이 생깁니다.",丙壬:"병임충(丙壬沖)입니다. 화(火)와 수(水)의 충돌로 열정과 냉정이 부딪힙니다. 감정 기복이 심해질 수 있습니다.",丁癸:"정계충(丁癸沖)입니다. 감성과 직관이 서로를 견제합니다. 마음 속을 잘 드러내지 않아 오해가 생길 수 있습니다.",子午:"자오충(子午沖)입니다. 수(水)와 화(火)의 강렬한 충돌입니다. 감정적으로 과격해지기 쉽고 회복이 오래 걸립니다.",丑未:"축미충(丑未沖)입니다. 두 토(土)의 충돌로 고집이 부딪히는 구조입니다. 서로 자기 방식을 고수하려 합니다.",寅申:"인신충(寅申沖)입니다. 목(木)과 금(金)의 충돌입니다. 자유와 통제 사이에서 갈등이 자주 발생합니다.",卯酉:"묘유충(卯酉沖)입니다. 감성과 이성의 충돌입니다. 서로의 접근 방식이 달라 이해하는 데 시간이 필요합니다.",辰戌:"진술충(辰戌沖)입니다. 토(土) 간의 강한 충돌입니다. 양쪽 모두 쉽게 물러서지 않아 합의가 어렵습니다.",巳亥:"사해충(巳亥沖)입니다. 금(金)과 수(水) 사이의 충돌입니다. 방향과 가치관이 달라 이견이 자주 나타납니다."},b={甲:"목",乙:"목",丙:"화",丁:"화",戊:"토",己:"토",庚:"금",辛:"금",壬:"수",癸:"수"},B={甲:"양",丙:"양",戊:"양",庚:"양",壬:"양",乙:"음",丁:"음",己:"음",辛:"음",癸:"음"},N={목:"화",화:"토",토:"금",금:"수",수:"목"},k={목:"토",화:"금",토:"수",금:"목",수:"화"},C={비견:{name:"비견(比肩)",desc:"같은 오행·같은 음양의 동지입니다. 서로를 너무 잘 알아 숨길 수 없지만, 경쟁심 없이 함께 걸어갈 수 있습니다."},겁재:{name:"겁재(劫財)",desc:"같은 오행이지만 음양이 달라 미묘하게 다릅니다. 서로 자극을 주고 경쟁심도 있지만, 그만큼 활기차고 역동적인 관계입니다."},식신:{name:"식신(食神)",desc:"나의 에너지가 자연스럽게 상대방으로 흘러갑니다. 내가 더 주는 역할을 맡는 편이지만, 편안하고 풍요로운 관계입니다."},상관:{name:"상관(傷官)",desc:"창의적이고 자유로운 에너지의 교류입니다. 틀에 얽매이지 않고 서로를 변화시키는 자극적인 관계입니다."},편인:{name:"편인(偏印)",desc:"상대방의 에너지가 일방적으로 나에게 흘러옵니다. 상대방이 더 지원해주지만, 의존이 깊어지면 주도성을 잃을 수 있습니다."},정인:{name:"정인(正印)",desc:"상대방이 안정적으로 나를 성장시켜줍니다. 스승과 같은 든든하고 신뢰감 있는 관계입니다."},편재:{name:"편재(偏財)",desc:"내가 상대방을 이끌고 활용하는 관계입니다. 능동적이고 주도적으로 관계를 이끌어갑니다."},정재:{name:"정재(正財)",desc:"안정적이고 현실적인 관계입니다. 서로에게 실질적으로 이로운 신뢰의 인연입니다."},편관:{name:"편관(偏官)",desc:"상대방이 나를 압박하는 구조입니다. 긴장감이 있지만 그것이 성장의 동력이 되기도 합니다."},정관:{name:"정관(正官)",desc:"상대방이 나를 올바르게 이끌어줍니다. 격식 있고 안정적인, 사회적으로도 인정받는 관계입니다."}},u=(je=(fe=e.pillarsA)==null?void 0:fe[2])==null?void 0:je.stem,V=(Se=(Ae=e.pillarsB)==null?void 0:Ae[2])==null?void 0:Se.stem,T=(r,I)=>{const R=b[r],J=b[I];if(!R||!J)return null;const Q=B[r]===B[I];return R===J?C[Q?"비견":"겁재"]:N[R]===J?C[Q?"식신":"상관"]:N[J]===R?C[Q?"편인":"정인"]:k[R]===J?C[Q?"편재":"정재"]:k[J]===R?C[Q?"편관":"정관"]:null},ie=T(u,V),Z=T(V,u),D=r=>{const I={};return r.forEach(R=>{const J=(R.type||"").split("(")[0].split("（")[0].trim(),Q=[String(R.a||""),String(R.b||"")].sort().join(""),ce=`${J}|${Q}`;I[ce]||(I[ce]={...R,pillars:[]});const he=(R.pillarA||"").slice(0,2),Fe=(R.pillarB||"").slice(0,2);(he||Fe)&&I[ce].pillars.push(`${he}·${Fe}`)}),Object.values(I)},A=D((e.hapChung||[]).filter(r=>r.positive)),i=D((e.hapChung||[]).filter(r=>!r.positive));A.length,i.length;const te=r=>{var J;const I=[r.a,r.b].sort().join("");let R="";if(r.type.includes("천간합")){const Q=M[I]||M[[r.b,r.a].join("")];Q&&(R=`<div class="gh-hap-desc">${Q.name} · ${Q.wx}의 기운 — ${Q.desc}</div>`)}else if(r.type.includes("지지육합")){const Q=[r.a,r.b].sort().join("");Object.values(W).find((he,Fe,He)=>Object.keys(He).find(Te=>Te.split("").sort().join("")===Q.split("").sort().join("")));const ce=Object.entries(W).find(([he])=>he.split("").sort().join("")===Q.split("").sort().join(""));ce&&(R=`<div class="gh-hap-desc">${ce[1].desc}</div>`)}else r.type.includes("삼합")&&(R='<div class="gh-hap-desc">삼합(三合)은 세 지지가 모여 강한 오행의 국(局)을 이루는 특수한 인연입니다. 두 분 사이에 운명적 연결고리가 있습니다.</div>');return`<div class="gh-hap-item positive">
      <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
        <span class="gh-hap-type">${r.type}</span>
        <span class="gh-hap-chars">${r.a} ↔ ${r.b}</span>
        ${(J=r.pillars)!=null&&J.length?`<span class="gh-hap-pill">${r.pillars.join(" / ")}</span>`:""}
      </div>
      ${R}
    </div>`},se=r=>{var J;const I=[r.a,r.b].sort().join(""),R=ne[I]||ne[[r.b,r.a].join("")]||"";return`<div class="gh-hap-item negative">
      <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
        <span class="gh-hap-type">${r.type}</span>
        <span class="gh-hap-chars">${r.a} ↔ ${r.b}</span>
        ${(J=r.pillars)!=null&&J.length?`<span class="gh-hap-pill">${r.pillars.join(" / ")}</span>`:""}
    ...
    </div>`},ve=e.hapChung&&e.hapChung.length>0?`
    <div class="gh-section">
      <div class="gh-section-title">⚡ 합충(合沖) 분석</div>
      ${A.length>0?`
        <div class="gh-hap-group">
          <div class="gh-hap-label positive">합(合) — 서로 끌어당기는 인연 · ${A.length}건</div>
          ${A.map(te).join("")}
        </div>`:""}
      ${i.length>0?`
      ...
      ${A.length===0&&i.length===0?'<div style="font-size:13px;color:rgba(255,255,255,0.4);text-align:center;padding:10px 0;">특별한 합충 관계 없음</div>':""}
    </div>`:"",_=e.distributionA||{},c=e.distributionB||{},h=["목","화","토","금","수"],L={목:"木(목)",화:"火(화)",토:"土(토)",금:"金(금)",수:"水(수)"},E={목:"창의·성장·인자함",화:"열정·표현·감수성",토:"안정·신뢰·중재력",금:"결단·원칙·날카로움",수:"지혜·직관·유연성"},y={};A.forEach(r=>{const I=[r.a,r.b].sort().join("");if((r.type||"").includes("천간합")){const R=M[I]||M[[r.b,r.a].join("")];R!=null&&R.wx&&(y[R.wx]=(y[R.wx]||0)+1)}});const re={목:"창의·성장",화:"정(情)·열정·인연",토:"안정·신뢰",금:"의리·결속",수:"지혜·유연성"},pe=Object.entries(y).sort((r,I)=>I[1]-r[1]),ge=pe.length>0?"✨ 합화오행: "+pe.map(([r,I])=>`<strong style="color:${w[r]||"#fff"}">${L[r]||r}(${re[r]})</strong>${I>1?` ×${I}`:""}`).join(" · ")+" 기운이 두 분 사이에서 생성됩니다.":"",ue=ie?`
    <div class="gh-card">
      <div class="gh-section">
        ...
        <div style="display:flex;gap:10px;flex-wrap:wrap;margin-top:8px;">
          <div style="flex:1;min-width:130px;padding:12px 14px;border-radius:10px;background:rgba(0,210,255,0.06);border:1px solid rgba(0,210,255,0.14);">
            <div style="font-size:11px;color:#00D2FF;font-weight:700;margin-bottom:5px;">나(${u||""}·${S})가 본 상대방</div>
            <div style="font-size:15px;font-weight:800;color:#fff;margin-bottom:5px;">${ie.name}</div>
            <div style="font-size:12px;color:rgba(255,255,255,0.65);line-height:1.6;">${ie.desc}</div>
          </div>
          <div style="flex:1;min-width:130px;padding:12px 14px;border-radius:10px;background:rgba(245,166,35,0.06);border:1px solid rgba(245,166,35,0.14);">
            <div style="font-size:11px;color:#F5A623;font-weight:700;margin-bottom:5px;">상대방(${V||""}·${z})이 본 나</div>
            <div style="font-size:15px;font-weight:800;color:#fff;margin-bottom:5px;">${Z.name}</div>
            <div style="font-size:12px;color:rgba(255,255,255,0.65);line-height:1.6;">${Z.desc}</div>
          </div>
        </div>
        ${ge?`<div class="gh-dist-interp good" style="margin-top:10px;">${ge}</div>`:""}
      </div>
    </div>`:"",ae={};h.forEach(r=>{ae[r]=(_[r]||0)+(c[r]||0)});const me=[...h].sort((r,I)=>(ae[r]||0)-(ae[I]||0)),s=me[0],l=me[me.length-1],x=h.filter(r=>Math.abs((_[r]||0)-(c[r]||0))>=2);let O="";if(s&&ae[s]<=1&&(O+=`<div class="gh-dist-interp">⚠ 두 분 모두 <strong style="color:${w[s]}">${L[s]}</strong>(${E[s]})이 부족합니다. 이 기운이 약한 영역에서 함께 어려움을 겪을 수 있습니다.</div>`),x.length>0){const r=x[0],I=(_[r]||0)>(c[r]||0);O+=`<div class="gh-dist-interp good">✓ <strong style="color:${w[r]}">${L[r]}</strong>에서 한 분이 강하고 다른 분이 약합니다. ${I?"나":"상대방"}의 ${L[r]} 기운이 ${I?"상대방":"나"}를 채워주는 긍정적인 보완 관계입니다.</div>`}ae[l]>=6&&(O+=`<div class="gh-dist-interp warn">△ 두 분 합산 <strong style="color:${w[l]}">${L[l]}</strong>이 과도합니다. 이 오행의 특성(${E[l]})이 지나치게 강해 균형을 잃을 수 있습니다.</div>`);const v=new Set(["甲","丙","戊","庚","壬"]),g=new Set(["乙","丁","己","辛","癸"]),Y=new Set(["子","寅","辰","午","申","戌"]),X=new Set(["丑","卯","巳","未","酉","亥"]),U=r=>{let I=0,R=0,J=0,Q=0;return r.forEach(ce=>{v.has(ce.stem)?I++:g.has(ce.stem)&&R++,Y.has(ce.branch)?J++:X.has(ce.branch)&&Q++}),{yangStem:I,yinStem:R,yangBranch:J,yinBranch:Q}},K=U(e.pillarsA||[]),H=U(e.pillarsB||[]),le=K.yangStem+K.yangBranch,P=K.yinStem+K.yinBranch,G=H.yangStem+H.yangBranch,oe=H.yinStem+H.yinBranch,de=(()=>{const r=le>P?"양(陽)형":le<P?"음(陰)형":"균형형",I=G>oe?"양(陽)형":G<oe?"음(陰)형":"균형형",R={"양(陽)형":"활동적이고 외향적입니다. 먼저 나서고 에너지를 발산하는 편입니다.","음(陰)형":"내성적이고 수용적입니다. 관찰하고 흡수하며 내면이 깊습니다.",균형형:"음양이 고르게 분포되어 상황에 따라 유연하게 대처합니다."};let J="";return r!==I?J="서로 다른 음양 기질이 만나 자연스러운 끌림이 생깁니다. 보완 관계가 형성됩니다.":r==="양(陽)형"?J="두 분 모두 적극적이라 활기차지만 주도권 갈등이 생길 수 있습니다.":r==="음(陰)형"?J="두 분 모두 내성적이라 서로를 깊이 이해하지만 먼저 나서는 것을 꺼릴 수 있습니다.":J="두 분 모두 균형 잡힌 기질로 상황 적응력이 좋습니다.",{typeA:r,typeB:I,descA:R[r],descB:R[I],chem:J}})(),xe=`
    <div class="gh-section">
      <div class="gh-section-title">🌊 오행 분포 비교</div>
      <div class="gh-dist-grid">
        ${h.map(r=>{const I=_[r]||0,R=c[r]||0,J=w[r]||"#fff";return`
          <div class="gh-dist-row">
            <span class="gh-dist-name" style="color:${J}">${d[r]||r}(${r})</span>
            <div class="gh-dist-bars">
              <div class="gh-bar-wrap">
                <div class="gh-bar gh-bar-a" style="width:${I/8*100}%;background:${J}"></div>
              </div>
              <span class="gh-bar-val">${I}</span>
              <span class="gh-bar-sep">vs</span>
              <span class="gh-bar-val">${R}</span>
              <div class="gh-bar-wrap">
                <div class="gh-bar gh-bar-b" style="width:${R/8*100}%;background:${J};opacity:0.5"></div>
              </div>
            </div>
          </div>`}).join("")}
      ...
      ${O?`<div style="margin-top:12px;display:flex;flex-direction:column;gap:6px;">${O}</div>`:""}
    </div>
    ...
    <div class="gh-section" style="margin-top:14px">
      ...
      <div style="display:flex;gap:10px;flex-wrap:wrap;margin-top:8px;">
        <div class="gh-yy-box" style="border-color:#00D2FF22;flex:1;min-width:130px;">
          <div class="gh-yy-label" style="color:#00D2FF;">나 — ${de.typeA}</div>
          <div class="gh-yy-bar">
            <div style="width:${le/8*100}%;background:#f0a030;height:6px;border-radius:3px;"></div>
          </div>
          <div style="font-size:11px;color:rgba(255,255,255,0.5);margin-bottom:4px;">양 ${le} · 음 ${P}</div>
          <div class="gh-yy-desc">${de.descA}</div>
        </div>
        <div class="gh-yy-box" style="border-color:#F5A62322;flex:1;min-width:130px;">
          <div class="gh-yy-label" style="color:#F5A623;">상대방 — ${de.typeB}</div>
          <div class="gh-yy-bar">
          ...
          <div class="gh-yy-desc">${de.descB}</div>
        </div>
      </div>
      <div class="gh-dist-interp good" style="margin-top:10px;">💬 ${de.chem}</div>
    </div>`,we={"상생(相生)":{strength:["오행이 서로를 살려주는 구조라 에너지 흐름이 자연스럽습니다. 함께 있을수록 활력이 생깁니다.","위기 상황에서도 한 쪽이 힘이 빠지면 다른 쪽이 자연스럽게 채워주는 패턴이 나옵니다.","서로 다른 기운이 맞물려 있어 장기적으로 성장하기에 유리한 구조입니다."],caution:["생해주는 쪽이 지속적으로 에너지를 쏟아야 하는 구조라, 한쪽이 일방적으로 소진될 수 있습니다. 의존이 심해지면 균형이 무너집니다.","좋은 궁합이라 해도 합충 결과에서 충(沖)이 많으면 실제 관계에서 충돌이 잦을 수 있습니다. 합충 결과를 반드시 함께 참고하세요."]},"동질형(同質型)":{strength:["같은 오행이라 상대방의 감정과 사고방식을 직관적으로 잘 이해합니다.","취향과 생활패턴이 비슷해 일상에서 충돌이 적은 편입니다."],caution:["같은 오행은 같은 약점도 공유합니다. 두 사람 모두 특정 상황에서 함께 무너질 가능성이 있습니다. 외부 조언자가 반드시 필요합니다.","자극이 없어 관계가 정체될 수 있습니다. 편안함이 무관심으로 이어지지 않도록 의도적인 노력이 필요합니다.","경쟁 심리가 생기면 회복이 어렵습니다. 역할을 명확히 구분하는 것이 중요합니다."]},"갈등형(葛藤型)":{strength:["서로 다른 강점을 지니고 있어, 역할을 명확히 나누면 강력한 팀이 될 수 있습니다.","자극이 강한 만큼 서로에게서 배울 점도 많습니다."],caution:["오행이 서로를 극(克)하는 구조입니다. 기본적으로 기운이 충돌하며 상대방을 억제하거나 억제당하는 패턴이 반복됩니다.","갈등 상황에서 한쪽이 지속적으로 참거나 양보해야 하는 구조가 만들어질 수 있습니다. 장기적으로 피로도가 높습니다.","감정적으로 격해지면 회복에 시간이 오래 걸립니다. 싸움의 패턴이 반복되지 않도록 사전에 규칙을 정해두는 것이 현실적입니다.","이 조합에서 좋은 관계를 유지하려면 일반적인 커플보다 훨씬 더 많은 의식적인 노력이 필요합니다."]},"평범형(平凡型)":{strength:["특별히 맞부딪히는 기운이 없어 갈등이 극단으로 치닫지는 않습니다.","안정적이고 예측 가능한 관계가 됩니다."],caution:['큰 시너지가 없어 함께 있어도 에너지가 높아지지 않을 수 있습니다. 관계에서 "설레는 느낌"을 찾기가 어렵습니다.',"권태기가 비교적 일찍 찾아올 수 있습니다. 의도적으로 새로운 경험을 만들어야 관계가 유지됩니다."]}},ye=p.relation==="비화(比和)"?"동질형(同質型)":p.relation==="상극(相剋)"?"갈등형(葛藤型)":p.relation==="중화(中和)"?"평범형(平凡型)":p.relation,$e=we[ye]||we["평범형(平凡型)"],Be=`
    <div class="gh-section">
    ...
    <div style="margin-bottom:10px;padding:10px 13px;background:rgba(255,255,255,0.04);border-radius:10px;border:1px solid rgba(255,255,255,0.08);font-size:12.5px;line-height:1.7;color:rgba(255,255,255,0.7);">
      ...
      <div class="gh-advice-group">
        ...
        ${$e.strength.map(r=>`<div class="gh-advice-item positive">✓ ${r}</div>`).join("")}
      </div>
      <div class="gh-advice-group" style="margin-top:10px">
        <div class="gh-advice-label caution">주의 요소</div>
        ${$e.caution.map(r=>`<div class="gh-advice-item caution">⚠ ${r}</div>`).join("")}
      </div>
    </div>`;a.innerHTML=`
    <!-- 홈 버튼 -->
    <div class="detail-nav-row" style="margin-bottom:16px;">
    ...
    <div class="gungham-card" style="--gc:${p.rgb||"0,210,255"}">
      <div class="gungham-top">
        <div class="gungham-elem" style="color:${p.colA}">${p.symA}<span class="gungham-elem-ko">(${S||""})</span></div>
        <div class="gungham-score-wrap">
          <svg class="gungham-ring" viewBox="0 0 80 80">
            ...
            <circle cx="40" cy="40" r="34" fill="none" stroke="${p.color}" stroke-width="7"
              stroke-dasharray="${2*Math.PI*34}" stroke-dashoffset="${2*Math.PI*34*(1-F/100)}"
        ...
        <div class="gungham-elem" style="color:${p.colB}">${p.symB}<span class="gungham-elem-ko">(${z||""})</span></div>
      </div>
    ...
    <!-- ③ 합충 분석 -->
    ${ve?`<div class="gh-card">${ve}</div>`:""}

    <!-- ④ 오행 분포 비교 -->
    <div class="gh-card">${xe}</div>
  ...
  `;const ke=document.getElementById("member-code-input"),ze=document.getElementById("member-code-btn");ze&&ze.addEventListener("click",()=>{ke&&ke.value.trim()===Ge?(Re(ke.value.trim()),Pe(e)):alert("코드가 올바르지 않습니다.")}),document.querySelectorAll(".detail-view-btn").forEach(r=>{r.addEventListener("click",()=>{const I=parseInt(r.dataset.templeIndex);Ie(e.results[I],e,f)})}),(Ce=document.getElementById("couple-go-home"))==null||Ce.addEventListener("click",()=>{var I;a.classList.add("hidden"),a.innerHTML="",window._gunghamContext=null;const r=document.getElementById("match-form");r&&(r.style.display=""),(I=document.getElementById("app"))==null||I.scrollIntoView({behavior:"smooth",block:"start"})}),function(){var He,Te,Ye,Ue;var I=(He=matchData==null?void 0:matchData.results)==null?void 0:He[0],R=((Te=I==null?void 0:I.temple)==null?void 0:Te.name)||"인연사찰",J=(I==null?void 0:I.score)||"",Q=(matchData==null?void 0:matchData.purpose)||"",ce="https://jamgong-inyeonsachal.vercel.app",he='🏯 나의 인연사찰은 "'+R+`"!
오행 궁합 `+J+"점 매칭 ("+Q+`)

내 사주에 맞는 사찰을 찾아보세요 👇
`+ce,Fe="내 인연사찰은 "+R+"! — 잼공인연사찰";(Ye=document.getElementById("share-kakao-btn"))==null||Ye.addEventListener("click",function(){var Oe;window.Kakao&&window.Kakao.isInitialized()?window.Kakao.Share.sendDefault({objectType:"feed",content:{title:Fe,description:"오행 궁합 "+J+"점 매칭 ("+Q+`)
내 사주에 맞는 사찰을 찾아보세요!`,imageUrl:"https://jamgong-inyeonsachal.vercel.app/og-image.png",link:{mobileWebUrl:ce,webUrl:ce}},buttons:[{title:"내 인연사찰 찾기",link:{mobileWebUrl:ce,webUrl:ce}}]}):navigator.share?navigator.share({title:Fe,text:he,url:ce}).catch(function(){}):(Oe=navigator.clipboard)==null||Oe.writeText(he).then(function(){alert(`카카오톡에 붙여넣기 하세요!

`+he)})}),(Ue=document.getElementById("share-copy-btn"))==null||Ue.addEventListener("click",function(){var qe;var Oe=document.getElementById("share-copy-btn");(qe=navigator.clipboard)==null||qe.writeText(ce).then(function(){Oe&&(Oe.textContent="✅ 복사됨!",setTimeout(function(){Oe.innerHTML="🔗 링크 복사"},2e3))}).catch(function(){alert("주소: "+ce)})})}(),(Me=document.getElementById("demo-detail-btn"))==null||Me.addEventListener("click",()=>{Ie({score:94,reason:"수(水) 기운이 부족한 사주에 이 사찰의 강한 수 기운이 지혜와 학업 운을 보완해줍니다. 북쪽 방위의 청정한 기운이 집중력을 높여줍니다.",temple:{name:"통도사",address:"경상남도 양산시 하북면 통도사로 108",lat:35.489166,lng:129.058611,foundedYear:646,history:"신라 선덕여왕 15년(646) 자장율사가 창건한 한국 3보 사찰"},detail:{templeOhaeng:"수",bearing:"북",distanceKm:12.3},weather:{condition:"맑음",temp:24}},{purpose:"학업운",distribution:{목:1,화:2,토:2,금:2,수:1},purposeGuide:[]},!0)}),a.scrollIntoView({behavior:"smooth"})}function dt(){var e=document.getElementById("app");if(!e)return;var a=document.getElementById("dream-page");if(a){a.style.display="";return}var f=[{emoji:"🐖",label:"돼지"},{emoji:"💧",label:"물"},{emoji:"🔥",label:"불"},{emoji:"🐍",label:"뱀"},{emoji:"🦷",label:"이빨"},{emoji:"📉",label:"추락"},{emoji:"☁️",label:"하늘"},{emoji:"🐕",label:"개"},{emoji:"☀️",label:"태양"},{emoji:"💵",label:"돈"},{emoji:"🐉",label:"용"},{emoji:"🐯",label:"호랑이"},{emoji:"🌙",label:"달"},{emoji:"🏠",label:"집"},{emoji:"🐟",label:"물고기"},{emoji:"🌸",label:"꽃"}],S=document.createElement("div");S.id="dream-page",S.style.cssText="width:100%;max-width:640px;margin:0 auto;padding:0 0 40px;",S.innerHTML=['<div style="margin-bottom:14px;">','  <button id="dream-back-btn" style="background:rgba(0,210,255,0.07);border:1px solid rgba(0,210,255,0.35);border-radius:10px;color:rgba(0,210,255,0.85);font-size:13px;font-weight:700;padding:8px 18px;cursor:pointer;box-shadow:0 0 12px rgba(0,210,255,0.2),inset 0 0 8px rgba(0,210,255,0.05);letter-spacing:0.3px;transition:all .2s;">← 홈으로</button>',"</div>",'<div style="text-align:center;padding:8px 0 14px;">','  <div style="display:inline-block;font-size:10px;font-weight:800;letter-spacing:2.5px;color:#c9a8ff;background:rgba(130,80,255,0.15);border:1px solid rgba(150,100,255,0.4);border-radius:20px;padding:5px 16px;margin-bottom:16px;box-shadow:0 0 14px rgba(130,80,255,0.2);">✦ TRADITIONAL DREAM INTERPRETER ✦</div>','  <div style="font-size:22px;font-weight:800;background:linear-gradient(135deg,#e8d5ff,#c9a8ff,#a78bfa);-webkit-background-clip:text;-webkit-text-fill-color:transparent;line-height:1.4;margin-bottom:10px;">무의식의 징검다리<br>전통 꿈해몽 연산실</div>','  <div style="font-size:13px;color:rgba(200,180,255,0.5);line-height:1.8;max-width:340px;margin:0 auto;">꿈 속 상징을 오행(목·화·토·금·수)과<br>불교·도교 전통으로 해석합니다</div>',"</div>",'<div style="background:rgba(20,10,40,0.6);border:1px solid rgba(150,100,255,0.2);border-radius:20px;padding:22px;margin-top:4px;box-shadow:0 4px 24px rgba(100,60,200,0.1);">','  <div style="font-size:11px;font-weight:800;color:rgba(200,170,255,0.6);margin-bottom:10px;letter-spacing:1.5px;">✍️ 꿈 이야기</div>','  <div style="position:relative;">','    <textarea id="dream-input" rows="5" maxlength="600" placeholder="꿈에서 일어난 일을 자유롭게 적어주세요..." style="width:100%;box-sizing:border-box;background:rgba(0,0,0,0.3);border:1px solid rgba(130,80,255,0.25);border-radius:14px;color:#e8d5ff;font-size:14px;line-height:1.8;padding:14px 50px 14px 16px;outline:none;resize:none;font-family:inherit;transition:border-color .2s;"></textarea>','    <button id="dream-voice-btn" title="음성 입력" style="position:absolute;right:10px;top:10px;background:rgba(130,80,255,0.25);border:1px solid rgba(150,100,255,0.5);border-radius:10px;color:#c9a8ff;font-size:18px;width:36px;height:36px;cursor:pointer;display:flex;align-items:center;justify-content:center;box-shadow:0 0 8px rgba(130,80,255,0.2);">🎙️</button>',"  </div>",'  <div id="dream-char-count" style="text-align:right;font-size:11px;color:rgba(200,170,255,0.3);margin-top:5px;">0 / 600</div>','  <div style="margin-top:16px;">','    <div style="font-size:11px;font-weight:800;color:rgba(200,170,255,0.5);margin-bottom:10px;letter-spacing:1.5px;">🔮 꿈 속 상징 선택 <span style="font-weight:400;opacity:.6;">(선택 사항)</span></div>','    <div id="dream-symbol-chips" style="display:flex;flex-wrap:wrap;gap:8px;">',f.map(function(b){return'<button class="dream-chip" data-label="'+b.label+'" style="background:rgba(100,60,200,0.1);border:1px solid rgba(150,100,255,0.2);border-radius:20px;color:rgba(210,185,255,0.7);font-size:12px;padding:6px 13px;cursor:pointer;transition:all .15s;">'+b.emoji+" "+b.label+"</button>"}).join(""),"    </div>","  </div>",'  <button id="dream-analyze-btn" style="width:100%;margin-top:20px;background:linear-gradient(135deg,#5b21b6,#7c3aed,#9333ea);border:none;border-radius:14px;color:#fff;font-size:15px;font-weight:800;padding:16px;cursor:pointer;letter-spacing:0.5px;box-shadow:0 4px 20px rgba(124,58,237,0.4);transition:all .2s;">',"    🔮 꿈 이야기 분석 &amp; 상징 조합 해설 구동","  </button>","</div>",'<div id="dream-result-section" style="display:none;margin-top:20px;background:linear-gradient(145deg,rgba(30,10,60,0.85),rgba(10,15,50,0.85));border:1px solid rgba(150,100,255,0.35);border-radius:20px;padding:24px;box-shadow:0 4px 30px rgba(100,60,200,0.15);"></div>','<div style="margin-top:24px;background:rgba(15,8,35,0.5);border:1px solid rgba(130,80,255,0.15);border-radius:18px;padding:20px;">','  <div style="font-size:12px;font-weight:800;color:rgba(200,170,255,0.6);margin-bottom:14px;letter-spacing:1px;">📖 꿈 일기</div>','  <div id="dream-diary-list" style="display:flex;flex-direction:column;gap:10px;"></div>','  <div id="dream-diary-empty" style="font-size:13px;color:rgba(200,170,255,0.25);text-align:center;padding:16px 0;">기록된 꿈이 없습니다</div>',"</div>",'<div style="margin-top:18px;padding:14px 18px;background:rgba(255,200,0,0.04);border:1px solid rgba(255,200,0,0.12);border-radius:12px;font-size:11px;color:rgba(255,230,150,0.4);line-height:1.8;">',"  ⚠️ 본 서비스는 전통 상징 해석 기반 문화 콘텐츠입니다. 의학적·법적 조언을 대신하지 않으며 결과는 참고용으로만 활용하시기 바랍니다.","</div>",'<div style="text-align:center;margin-top:18px;font-size:11px;color:rgba(200,170,255,0.2);line-height:2.2;">',"  특허 출원 중 (출원번호: 40-2026-00*****)<br>",'  <span style="letter-spacing:1px;">Jamgong Metaphysics Core Engine v1.8</span>',"</div>"].join("");var z=document.getElementById("match-form");z&&z.parentNode?z.parentNode.insertBefore(S,z.nextSibling):e.appendChild(S),S.style.display="";var p=document.getElementById("dream-back-btn");p&&p.addEventListener("click",function(){S.style.display="none",document.getElementById("match-form").style.display="",document.getElementById("temple-search-wrap").style.display="",document.querySelectorAll(".mode-toggle-btn").forEach(function(B){B.classList.remove("active")});var b=document.querySelector('.mode-toggle-btn[data-mode="solo"]');b&&b.classList.add("active")});var m=document.getElementById("dream-input"),$=document.getElementById("dream-char-count");m.addEventListener("input",function(){$.textContent=m.value.length+" / 600"});var n=[];S.querySelectorAll(".dream-chip").forEach(function(b){b.addEventListener("click",function(){var B=b.dataset.label,N=n.indexOf(B);N===-1?(n.push(B),b.style.background="rgba(130,80,255,0.3)",b.style.borderColor="rgba(130,80,255,0.7)",b.style.color="#d8b4ff",m.value&&!m.value.endsWith(" ")&&(m.value+=" "),m.value+=B+" ",$.textContent=m.value.length+" / 600"):(n.splice(N,1),b.style.background="rgba(255,255,255,0.05)",b.style.borderColor="rgba(255,255,255,0.12)",b.style.color="rgba(255,255,255,0.65)")})});var t=document.getElementById("dream-voice-btn"),F=!1,w=null;t.addEventListener("click",function(){var b=window.SpeechRecognition||window.webkitSpeechRecognition;if(!b){alert("이 브라우저는 음성 입력을 지원하지 않습니다.");return}if(F){w&&w.stop(),F=!1,t.style.background="rgba(130,80,255,0.2)",t.textContent="🎙️";return}w=new b,w.lang="ko-KR",w.interimResults=!1,w.onstart=function(){F=!0,t.style.background="rgba(255,60,60,0.3)",t.textContent="⏹️"},w.onresult=function(B){var N=B.results[0][0].transcript;m.value+=(m.value?" ":"")+N,$.textContent=m.value.length+" / 600"},w.onend=function(){F=!1,t.style.background="rgba(130,80,255,0.2)",t.textContent="🎙️"},w.start()});var d=document.getElementById("dream-analyze-btn"),j=document.getElementById("dream-result-section");d.addEventListener("click",function(){var b=m.value.trim();if(!b&&n.length===0){alert("꿈 내용을 입력하거나 상징을 선택해주세요.");return}d.disabled=!0,d.textContent="⏳ 분석 중...",j.style.display="block",j.innerHTML='<div style="text-align:center;padding:30px;color:rgba(255,255,255,0.4);font-size:14px;">🔮 꿈을 해석하고 있습니다...<br><span style="font-size:12px;opacity:.6;">잠시만 기다려주세요</span></div>',fetch("/api/dream",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({dreamText:b,symbols:n})}).then(function(B){return B.json()}).then(function(B){var N=B.result||"",k=M(N);k+='<div style="text-align:center;margin-top:18px;"><button id="dream-tts-btn" style="background:rgba(0,210,255,0.08);border:1px solid rgba(0,210,255,0.3);border-radius:12px;color:rgba(0,210,255,0.85);font-size:13px;font-weight:700;padding:10px 22px;cursor:pointer;box-shadow:0 0 12px rgba(0,210,255,0.15);transition:all .2s;">🔊 결과 읽어주기</button></div>',j.innerHTML=k;var C=document.getElementById("dream-tts-btn"),u=!1;C&&window.speechSynthesis?C.addEventListener("click",function(){if(u){window.speechSynthesis.cancel(),u=!1,C.textContent="🔊 결과 읽어주기";return}var V=N.replace(/##[^#]*##/g,"").replace(/\*\*/g,"").replace(/\*/g,"").replace(/#+/g,"").replace(/[·•▪▸►◆■□▶]/g,",").replace(/[-—–]{2,}/g,"").replace(/[✦✧★☆◇]/g,"").replace(/\[([^\]]+)\]/g,"$1").replace(/\n{2,}/g,". ").replace(/\n/g," ").replace(/\s{2,}/g," ").trim(),T=new window.SpeechSynthesisUtterance(V);T.lang="ko-KR",T.rate=.92,T.pitch=1;var ie=window.speechSynthesis.getVoices(),Z=ie.find(function(D){return D.lang.startsWith("ko")});Z&&(T.voice=Z),T.onstart=function(){u=!0,C.textContent="⏹ 중지"},T.onend=function(){u=!1,C.textContent="🔊 결과 읽어주기"},T.onerror=function(){u=!1,C.textContent="🔊 결과 읽어주기"},window.speechSynthesis.speak(T)}):C&&(C.style.display="none"),window._dreamContext={dreamText:b,symbols:n,result:N},window._sajuContext=null,window._gunghamContext=null,W(b,n,N),ne()}).catch(function(B){j.innerHTML='<div style="color:#ff8080;padding:20px;font-size:14px;">오류가 발생했습니다: '+B.message+"</div>"}).finally(function(){d.disabled=!1,d.innerHTML="🔮 꿈 이야기 분석 &amp; 상징 조합 해설 구동",j.scrollIntoView({behavior:"smooth",block:"start"})})}),ne();function M(b){var B=[{key:"##오행분석##",icon:"☯️",title:"오행 분석"},{key:"##핵심상징##",icon:"🔑",title:"핵심 상징"},{key:"##길흉판단##",icon:"⚖️",title:"길흉 판단"},{key:"##조언##",icon:"💡",title:"조언"},{key:"##오행처방##",icon:"🌿",title:"오행 처방"}],N={};B.forEach(function(C,u){var V=b.indexOf(C.key);if(V!==-1){for(var T=V+C.key.length,ie=b.length,Z=u+1;Z<B.length;Z++){var D=b.indexOf(B[Z].key);D!==-1&&D<ie&&(ie=D)}N[C.key]=b.slice(T,ie).trim()}});var k='<div style="font-size:11px;font-weight:800;letter-spacing:2.5px;color:#c9a8ff;margin-bottom:20px;text-align:center;opacity:.9;">✦ 꿈해몽 결과 ✦</div>';return B.forEach(function(C){var u=N[C.key];u&&(k+='<div style="margin-bottom:14px;padding:16px 18px;background:rgba(100,60,200,0.08);border-radius:14px;border-left:3px solid rgba(167,139,250,0.6);">',k+='<div style="font-size:12px;font-weight:800;color:#a78bfa;margin-bottom:8px;letter-spacing:0.5px;">'+C.icon+" "+C.title+"</div>",k+='<div style="font-size:13px;color:rgba(230,215,255,0.8);line-height:1.9;white-space:pre-wrap;">'+u+"</div>",k+="</div>")}),k.includes("background:rgba")||(k+='<div style="font-size:13px;color:rgba(255,255,255,0.7);line-height:1.8;white-space:pre-wrap;">'+b+"</div>"),k}function W(b,B,N){try{var k=JSON.parse(localStorage.getItem("dreamDiary")||"[]");k.unshift({date:new Date().toLocaleDateString("ko-KR"),time:new Date().toLocaleTimeString("ko-KR",{hour:"2-digit",minute:"2-digit"}),text:b.slice(0,80),symbols:B,result:N.slice(0,200)}),k.length>20&&(k=k.slice(0,20)),localStorage.setItem("dreamDiary",JSON.stringify(k))}catch{}}function ne(){var b=document.getElementById("dream-diary-list"),B=document.getElementById("dream-diary-empty");if(b)try{var N=JSON.parse(localStorage.getItem("dreamDiary")||"[]");if(!N.length){B.style.display="",b.innerHTML="";return}B.style.display="none",b.innerHTML=N.map(function(k,C){return'<div style="padding:12px 14px;background:rgba(255,255,255,0.04);border-radius:10px;border:1px solid rgba(255,255,255,0.07);"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:5px;"><span style="font-size:11px;color:rgba(255,255,255,0.3);">'+k.date+" "+k.time+"</span>"+(k.symbols&&k.symbols.length?'<span style="font-size:11px;color:rgba(130,80,255,0.7);">'+k.symbols.join(", ")+"</span>":"")+'</div><div style="font-size:13px;color:rgba(255,255,255,0.6);line-height:1.6;">'+(k.text||"").replace(/</g,"&lt;")+(k.text&&k.text.length>=80?"…":"")+"</div></div>"}).join("")}catch{B.style.display=""}}}nt();(function(){var e=document.querySelector("#cm .cmsg.bot");e&&(e.innerHTML="안녕하세요! 인연 길잡이예요 😊<br>사찰 방문, 사주팔자, 오행, 꿈해몽 등 무엇이든 물어보세요.")})();(function(){const a=document.getElementById("temple-search-input"),f=document.getElementById("temple-search-results"),S=document.getElementById("temple-search-clear"),z=document.getElementById("region-btn"),p=document.getElementById("region-label"),m=document.getElementById("region-list");if(!a||!f)return;let $=[],n={},t="",F=!1;fetch("/api/temple-list").then(function(d){return d.ok?d.json():[]}).then(function(d){$=d,n={},d.forEach(function(j){j.id&&(n[j.id]=j)}),F=!0,(t||a.value.trim())&&w(a.value)}).catch(function(){$=[],F=!0}),z&&m&&(z.addEventListener("click",function(d){d.stopPropagation(),m.style.display=m.style.display==="none"?"block":"none"}),m.querySelectorAll(".rg-item").forEach(function(d){d.addEventListener("mouseover",function(){this.style.background="rgba(255,255,255,0.1)"}),d.addEventListener("mouseout",function(){this.style.background=""}),d.addEventListener("click",function(j){j.stopPropagation(),t=this.dataset.val||"",p&&(p.textContent=t?"📍 "+t:"📍 전체 지역"),m.style.display="none",w(a.value)})}),document.addEventListener("click",function(){m.style.display="none"}));function w(d){if(d=(d||"").trim(),S.style.display=d?"block":"none",!d&&!t){f.style.display="none";return}if(!F){f.innerHTML='<div style="padding:14px 18px;font-size:13px;color:rgba(255,255,255,0.5);">⏳ 사찰 목록 로딩 중...</div>',f.style.display="block";return}var j={},M=[],W=[],ne=[];$.forEach(function(u){if(!j[u.id]){var V=!t||u.address&&u.address.includes(t);if(V){var T=!d||u.name&&u.name.includes(d),ie=d&&u.address&&u.address.includes(d),Z=d&&u.history&&u.history.includes(d);T?(j[u.id]=!0,M.push(u)):ie?(j[u.id]=!0,W.push(u)):Z&&(j[u.id]=!0,ne.push(u))}}});var b=M.concat(W).concat(ne).sort(function(u,V){return(u.name||"").localeCompare(V.name||"","ko")});window._lastSearchMatches=b;var B="";if(b.length){var N='<div style="padding:8px 16px 6px;font-size:11px;color:rgba(255,255,255,0.35);border-bottom:1px solid rgba(255,255,255,0.06);">🏯 데이터베이스 '+b.length+"개</div>";B=N+b.map(function(u,V){var T=(u.address||"").slice(0,28);return d&&u.history&&u.history.includes(d)&&!(u.name||"").includes(d)&&!(u.address||"").includes(d)&&(T="연혁: "+u.history.slice(0,28)+"…"),'<div class="tsearch-item" data-idx="'+V+'" style="padding:12px 16px;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.06);display:flex;align-items:center;gap:10px;transition:background .12s;"><span style="font-size:16px;">🏯</span><div><div style="font-size:14px;font-weight:700;color:#fff;">'+(u.name||"")+'</div><div style="font-size:12px;color:rgba(255,255,255,0.4);margin-top:2px;">'+T+"</div></div></div>"}).join("")}else B='<div style="padding:10px 18px 4px;font-size:12px;color:rgba(255,255,255,0.3);">데이터베이스 결과 없음</div>';if(f.innerHTML=B+'<div id="kakao-extra-results"><div style="padding:10px 16px;font-size:11px;color:rgba(255,200,0,0.4);">⏳ 카카오 추가 검색 중...</div></div>',f.style.display="block",d){var k="/api/temple-search?q="+encodeURIComponent(d)+(t?"&region="+encodeURIComponent(t):"");fetch(k).then(function(u){return u.json()}).then(function(u){var V=document.getElementById("kakao-extra-results");if(V){var T=(u.places||[]).filter(function(Z){return!b.some(function(D){return D.name===Z.name})});if(!T.length){V.innerHTML="";return}window._kakaoPlaces=T;var ie='<div style="padding:8px 16px 6px;font-size:11px;color:rgba(255,200,0,0.5);border-top:1px solid rgba(255,255,255,0.06);border-bottom:1px solid rgba(255,255,255,0.06);">🗺️ 카카오 추가 검색 '+T.length+"개</div>";V.innerHTML=ie+T.map(function(Z,D){var A=(Z.address||"").slice(0,28);return'<div class="kakao-item" data-kidx="'+D+'" style="padding:12px 16px;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.04);display:flex;align-items:center;gap:10px;transition:background .12s;"><span style="font-size:16px;">🗺️</span><div><div style="font-size:14px;font-weight:700;color:#ffe89a;">'+(Z.name||"")+'</div><div style="font-size:12px;color:rgba(255,255,255,0.35);margin-top:2px;">'+A+"</div></div></div>"}).join("")}}).catch(function(){var u=document.getElementById("kakao-extra-results");u&&(u.innerHTML="")})}else{var C=document.getElementById("kakao-extra-results");C&&(C.innerHTML="")}}a.addEventListener("input",function(){w(this.value)}),S.addEventListener("click",function(){a.value="",S.style.display="none",f.style.display="none",a.focus()}),f.addEventListener("click",function(d){var j=d.target.closest(".tsearch-item");if(j){var M=parseInt(j.dataset.idx),W=window._lastSearchMatches||[],ne=M>=0&&W[M]?W[M]:null;if(!ne)return;a.value="",f.style.display="none",S.style.display="none";var b={temple:ne,detail:{templeOhaeng:"금",bearing:"—",distanceKm:null},score:0,reason:"직접 검색하신 사찰입니다.",weather:null},B=document.getElementById("results"),N=document.getElementById("match-form"),k=document.getElementById("temple-search-wrap");Ie(b,null,!1,function(){B&&(B.innerHTML="",B.classList.add("hidden")),N&&(N.style.display=""),k&&(k.style.display="")});return}var C=d.target.closest(".kakao-item");if(C){var u=parseInt(C.dataset.kidx),V=window._kakaoPlaces||[],T=V[u];if(!T)return;a.value="",f.style.display="none",S.style.display="none";var ie={id:T.id,name:T.name,address:T.address,lat:T.lat,lng:T.lng,history:"",foundedYear:null},Z={temple:ie,detail:{templeOhaeng:"금",bearing:"—",distanceKm:null},score:0,reason:"카카오 검색 결과입니다.",weather:null},D=document.getElementById("results"),A=document.getElementById("match-form"),i=document.getElementById("temple-search-wrap");Ie(Z,null,!1,function(){D&&(D.innerHTML="",D.classList.add("hidden")),A&&(A.style.display=""),i&&(i.style.display="")})}}),document.addEventListener("click",function(d){var j=document.getElementById("temple-search-wrap");j&&!j.contains(d.target)&&(f.style.display="none")})})();
