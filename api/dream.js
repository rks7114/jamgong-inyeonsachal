...
const SYMBOL_MAP = {
  ...
  '용':     { ohaeng: '목', meaning: '위엄·변신·큰 성공·제왕의 기운. 대업을 이룰 징조.' },
  '호랑이': { ohaeng: '금', meaning: '권위·용기·강인함·위험. 강한 의지와 도전의 상징.' },
  '달':     { ohaeng: '수', meaning: '음기·직관·감정·무의식. 내면 세계의 탐색.' },
  '집':     { ohaeng: '토', meaning: '자아·안정·가족·뿌리. 내 삶의 기반에 대한 신호.' },
  '물고기': { ohaeng: '수', meaning: '풍요·지혜·자유·무의식의 세계. 깊은 내면의 메시지.' },
  '꽃':     { ohaeng: '목', meaning: '아름다움·성장·새로운 시작·결실. 생명력의 표현.' },
};
